/* JSModeler 0.44 - http://www.github.com/kovacsv/JSModeler */
'use strict';
var JSM = function () {
  this.mainVersion = 0;
  this.subVersion = 44
...
JSM.CopyObjectProperties = function (a, b, c) {
  if (!(void 0 === a || null === a || void 0 === b || null === b))
    for (var d in a)
      if (a.hasOwnProperty(d) && (c || void 0 === b[d] || null === b[d])) b[d] = a[d]
};
...
JSM.FPSCounter.prototype.Get = function (a) {
  ...
  null === this.start && (this.start = b, this.current = this.frames = 0);
  if (null === a || void 0 === a) a = 1E3;
  this.frames += 1;
  var c = b - this.start;
  c >= a && (this.current = 1E3 * (this.frames / c), this.start = b, this.frames = 0);
...
JSM.BubbleSort = function (a, b, c) {
  if (2 > a.length || void 0 === b || null === b) return !1;
  if (void 0 === c || null === c) c = function (b, c) {
    JSM.SwapArrayValues(a, b, c)
  };
  var d, e;
  for (d = 0; d < a.length - 1; d++)
    for (e = 0; e < a.length - d - 1; e++) b(a[e], a[e + 1]) || c(e, e + 1);
  return !0
};
JSM.ShiftArray = function (a, b) {
  var c;
  for (c = 0; c < b; c++) a.push(a.shift())
};
JSM.AsyncRunTask = function (a, b, c, d, e) {
  function f(b, e, k) {
    var l = a();
    if (void 0 !== k.onProgress && null !== k.onProgress) k.onProgress(b, e);
    l && b < c - 1 ? setTimeout(function () {
      f(b + 1, e, k)
    }, d) : setTimeout(function () {
      if (void 0 !== k.onFinish && null !== k.onFinish) k.onFinish(e)
    }, d)
  }
  if (void 0 === b || null === b)
    for (b = 0; b < c && !(e = a(), !e); b++);
  else {
    if (void 0 !== b.onStart && null !== b.onStart) b.onStart(c, e);
    f(0, e, b)
  }
};
JSM.IsWebGLEnabled = function () {
  ...
  try {
    ...
    if (!a.getContext("experimental-webgl") && !a.getContext("webgl")) return !1
  } catch (b) {
    return !1
  }
  return !0
...
JSM.CalculateCentroid = function (a) {
  ...
  if (1 <= b) {
    var d;
    for (d = 0; d < b; d++) c = JSM.CoordAdd(c, a[d]);
...
JSM.CalculateNormal = function (a) {
  ...
  if (3 <= b) {
    var d, e, f;
    for (d = 0; d < b; d++) e = d % b, f = (d + 1) % b, e = a[e], f = a[f], c.x += (e.y - f.y) * (e.z + f.z), c.y += (e.z - f.z) * (e.x + f.x), c.z += (e.x - f.x) * (e.y + f.y)
  }
  c.Normalize();
  return c
};
...
JSM.MatrixRotation = function (a, b, c) {
  ...
  b = Math.cos(b);
  var l = [];
  if (void 0 === c || null === c) l[0] = f + (g + h) * b, l[1] = a * e * (1 - b) + d * k, l[2] = a * d * (1 - b) - e * k, l[3] = 0, l[4] = a * e * (1 - b) - d * k, l[5] = g + (f + h) * b, l[6] = e * d * (1 - b) + a * k, l[7] = 0, l[8] = a * d * (1 - b) + e * k, l[9] = e * d * (1 - b) - a * k, l[10] = h + (f + g) * b, l[11] = 0, l[12] = 0, l[13] = 0, l[14] = 0;
  else {
    var m = c.x,
      n = c.y;
    c = c.z;
...
JSM.Sector2D.prototype.CoordPosition = function (a) {
  var b = a.x,
    ...
    g = this.end.y,
    h = this.GetLength();
  if (JSM.IsZero(h)) return a.IsEqual(this.beg) ? JSM.CoordSectorPosition2D.CoordOnSectorEndCoord : JSM.CoordSectorPosition2D.CoordOutsideOfSector;
  a = ((b - d) * (f - d) + (c - e) * (g - e)) / (h * h);
  if (JSM.IsLower(a, 0) || JSM.IsGreater(a, 1)) return JSM.CoordSectorPosition2D.CoordOutsideOfSector;
  e += a * (g - e);
  return !JSM.IsEqual(d + a * (f - d), b) || !JSM.IsEqual(e, c) ? JSM.CoordSectorPosition2D.CoordOutsideOfSector :
...
JSM.Sector2D.prototype.SectorPosition = function (a, b) {
  ...
  if (k && l) return JSM.SectorSectorPosition2D.SectorsIntersectCoincident;
  var m = e.x,
    n = e.y,
    q = f.x,
    p = f.y,
  ...
  if (JSM.IsZero(r)) {
    if (JSM.IsZero(t) && JSM.IsZero(y)) {
      if (c(e, f, g) || c(e, f, h) || c(g, h, e) || c(g, h, f)) return JSM.SectorSectorPosition2D.SectorsIntersectCoincident;
      if (k) return d && (b.x = e.x, b.y = e.y), JSM.SectorSectorPosition2D.SectorsIntersectEndPoint;
      if (l) return d && (b.x = f.x, b.y = f.y), JSM.SectorSectorPosition2D.SectorsIntersectEndPoint
    }
  ...
  y /= r;
  if (JSM.IsLower(g,
      0) || JSM.IsGreater(g, 1) || JSM.IsLower(y, 0) || JSM.IsGreater(y, 1)) return JSM.SectorSectorPosition2D.SectorsDontIntersect;
  if (k) return d && (b.x = e.x, b.y = e.y), JSM.SectorSectorPosition2D.SectorsIntersectEndPoint;
  if (l) return d && (b.x = f.x, b.y = f.y), JSM.SectorSectorPosition2D.SectorsIntersectEndPoint;
  d && (b.x = m + g * (q - m), b.y = n + g * (p - n));
...
JSM.Sector2D.prototype.ProjectCoord = function (a) {
  ...
  var d = this.end,
    ...
    h = d.y,
    k = (g - e) * (g - e) + (h - f) * (h - f);
  if (JSM.IsZero(k)) return a.Clone();
  b = ((g - e) * (b - e) + (h - f) * (c - f)) / k;
  if (JSM.IsLower(b, 0)) return a.Clone();
  if (JSM.IsGreater(b, 1)) return d.Clone();
...
JSM.Sector.prototype.CoordPosition = function (a) {
  ...
  if (JSM.IsZero(q)) return e.IsEqual(a) ? JSM.CoordSectorPosition.CoordOnSectorEndCoord : JSM.CoordSectorPosition.CoordOutsideOfSector;
  b = ((l - g) * (b - g) + (m - h) * (c - h) + (n - k) * (d - k)) / q;
  f = f.Clone().MultiplyScalar(b);
  e = JSM.CoordAdd(e, f);
  a = a.DistanceTo(e);
  return JSM.IsZero(a) ? JSM.IsLower(b, 0) || JSM.IsGreater(b, 1) ? JSM.CoordSectorPosition.CoordOutsideOfSector :
    JSM.IsEqual(b, 0) || JSM.IsEqual(b, 1) ? JSM.CoordSectorPosition.CoordOnSectorEndCoord : JSM.CoordSectorPosition.CoordInsideOfSector : JSM.CoordSectorPosition.CoordOutsideOfSector
};
...
JSM.GetSectorSegmentation2D = function (a, b) {
  var c = JSM.CoordSub2D(a.end, a.beg),
    d = a.beg.DistanceTo(a.end) / b,
    e = 0,
    f = [],
    g, h;
  for (g = 0; g <= b; g++) h = a.beg.Clone().Offset(c, e), f.push(h), e += d;
  return f
};
JSM.GetSectorSegmentation = function (a, b) {
  var c = JSM.CoordSub(a.end, a.beg),
    d = a.beg.DistanceTo(a.end) / b,
    e = 0,
    f = [],
    g, h;
...
JSM.Line2D.prototype.LinePosition = function (a, b) {
  var c = this.start.x,
    ...
    n = (e - c) * (d - h) - (f - d) * (c - g),
    g = (l - h) * (e - c) - (k - g) * (f - d);
  if (JSM.IsZero(g)) return JSM.IsZero(m) && JSM.IsZero(n) ? JSM.LineLinePosition2D.LinesIntersectsCoincident : JSM.LineLinePosition2D.LinesDontIntersect;
  m /= g;
  null !== b && (b.x = c + m * (e - c), b.y = d + m * (f - d));
...
JSM.Line.prototype.CoordPosition = function (a, b) {
  ...
  if (JSM.IsZero(p)) return void 0 !== b && b.Set(f.x, f.y, f.z), f.IsEqual(a) ? JSM.CoordLinePosition.CoordOnLine : JSM.CoordLinePosition.CoordOutsideOfLine;
  c = g.Clone().MultiplyScalar(((m - h) * (c - h) + (n - k) * (d - k) + (q - l) * (e - l)) / p);
  f = JSM.CoordAdd(f, c);
  void 0 !== b && b.Set(f.x, f.y, f.z);
  f = a.DistanceTo(f);
  return JSM.IsZero(f) ? JSM.CoordLinePosition.CoordOnLine :
    JSM.CoordLinePosition.CoordOutsideOfLine
};
JSM.Line.prototype.ProjectCoord = function (a) {
  ...
  if (JSM.IsZero(n)) return a.Clone();
...
JSM.Line.prototype.ClosestPoint = function (a, b, c) {
  ...
  var k = JSM.CoordAdd(a, h),
    ...
    l = d(l, 3, 2, 3, 2),
    m = m * l - k * k;
  if (JSM.IsEqual(m, 0)) return !1;
  n = (g * k - n * l) / m;
  g = (g + n * k) / l;
  void 0 !== b && (e.MultiplyScalar(n), e =
    JSM.CoordAdd(f, e), b.Set(e.x, e.y, e.z));
  void 0 !== c && (h.MultiplyScalar(g), b = JSM.CoordAdd(a, h), c.Set(b.x, b.y, b.z));
  return !0
};
JSM.Line.prototype.LinePosition = function (a, b) {
  var c = new JSM.Coord(0, 0, 0),
    d = new JSM.Coord(0, 0, 0);
  return !this.ClosestPoint(a, c, d) ? JSM.LineLinePosition.LinesIntersectsCoincident : c.IsEqual(d) ? (void 0 !== b && b.Set(c.x, c.y, c.z), JSM.LineLinePosition.LinesIntersectsOnePoint) : JSM.LineLinePosition.LinesDontIntersect
};
...
JSM.RotationXTransformation = function (a, b) {
  ...
  void 0 === b || null === b ? c.matrix = JSM.MatrixRotationX(a) : (c.Append(JSM.TranslationTransformation(new JSM.Vector(-b.x, -b.y, -b.z))), c.Append(JSM.RotationXTransformation(a)), c.Append(JSM.TranslationTransformation(new JSM.Vector(b.x, b.y, b.z))));
  return c
};
JSM.RotationYTransformation = function (a, b) {
  var c = new JSM.Transformation;
  void 0 === b || null === b ? c.matrix = JSM.MatrixRotationY(a) : (c.Append(JSM.TranslationTransformation(new JSM.Vector(-b.x, -b.y, -b.z))), c.Append(JSM.RotationYTransformation(a)), c.Append(JSM.TranslationTransformation(new JSM.Vector(b.x, b.y, b.z))));
  return c
};
JSM.RotationZTransformation = function (a, b) {
  var c = new JSM.Transformation;
  void 0 === b || null === b ? c.matrix = JSM.MatrixRotationZ(a) : (c.Append(JSM.TranslationTransformation(new JSM.Vector(-b.x, -b.y, -b.z))), c.Append(JSM.RotationZTransformation(a)), c.Append(JSM.TranslationTransformation(new JSM.Vector(b.x, b.y, b.z))));
  return c
};
...
JSM.Plane.prototype.LinePosition = function (a, b) {
  ...
  if (JSM.IsZero(m)) return JSM.LinePlanePosition.LineParallelToPlane;
  void 0 !== b && (c.MultiplyScalar((g * d + h * e + k * f + l) / m), c = JSM.CoordAdd(a.start, c), b.Set(c.x, c.y, c.z));
...
JSM.MatrixView = function (a, b, c) {
  if (a.IsEqual(b)) return JSM.MatrixIdentity();
  var d = [];
...
JSM.ConvexHull2D = function (a) {
  function b(a, b) {
    var c = a.length,
      d = 0,
      e;
    for (e = 1; e < c; e++) b == d ? d = e : JSM.CoordOrientation2D(a[b], a[d], a[e]) == JSM.Orientation.Clockwise && (d = e);
    return d
  }
  var c = [];
  if (3 > a.length) return c;
  var d = function (a) {
      var b = a.length,
        c = JSM.Inf,
        d = -1,
        e, f;
      for (e = 0; e < b; e++) f = a[e].x, JSM.IsLower(f, c) && (c = f, d = e);
      return d
    }(a),
    e = d,
    f;
  do c.push(e), e = f = b(a, e); while (f != d);
  return c
};
JSM.ConvexHull3D = function (a) {
  ...
  function f(a, b, d, e) {
    ...
    for (g = 0; g < a.edges.length; g++)
      if (h = a.edges[g], h.vert1 == d && h.vert2 == e || h.vert1 == e && h.vert2 == d) {
        f = g;
        break
      } - 1 == f && (f = new c, f.vert1 = d, f.vert2 = e, f.tri1 = -1, f.tri2 = -1, a.edges.push(f), f = a.edges.length - 1);
    a = a.edges[f];
  ...
  function l(a, b) {
    var c = [],
      d, e;
    for (d = 0; d < a.triangles.length; d++) e = a.triangles[d], e.valid ? !JSM.IsLower(k(a, e.vertices[0], e.vertices[2], e.vertices[1], b), 0) ? c.push(!0) : c.push(!1) : c.push(!1);
    var f, l, m, n = [];
    for (d = 0; d < c.length; d++) c[d] && (e = a.triangles[d], e.valid && (f = a.edges[e.edges[0]], l = a.edges[e.edges[1]], m = a.edges[e.edges[2]], f = -1 == f.tri1 || -1 == f.tri2 || c[f.tri1] != c[f.tri2], l = -1 == l.tri1 || -1 == l.tri2 || c[l.tri1] != c[l.tri2], m = -1 == m.tri1 || -1 == m.tri2 || c[m.tri1] !=
      c[m.tri2], f && n.push([e.vertices[0], e.vertices[1], b]), l && n.push([e.vertices[1], e.vertices[2], b]), m && n.push([e.vertices[2], e.vertices[0], b])));
    for (d = 0; d < c.length; d++) c[d] && (e = a.triangles[d], e.valid && (e = a, m = d, f = e.triangles[m], f.valid && (h(e, m, f.edges[0]), h(e, m, f.edges[1]), h(e, m, f.edges[2]), f.valid = !1)));
    for (d = 0; d < n.length; d++) c = n[d], g(a, c[0], c[1], c[2])
  }
  var m = [],
    n = a.length;
  if (4 > n) return m;
  ...
  for (p = 4; p < n; p++) l(q, p);
  for (p = 0; p < q.triangles.length; p++) a = q.triangles[p], a.valid && m.push(a.vertices);
  return m
};
JSM.Complexity = {
  Invalid: 0,
...
JSM.Polygon2D.prototype.GetSignedArea = function () {
  if (null !== this.cache.signedArea) return this.cache.signedArea;
  var a = this.vertices.length,
    b = 0;
  if (3 <= a) {
    var c, d, e;
    for (c = 0; c < a; c++) d = this.vertices[c], e = this.vertices[(c + 1) % a], b += d.x * e.y - e.x * d.y;
    b *= 0.5
  }
...
JSM.Polygon2D.prototype.GetOrientation = function () {
  if (null !== this.cache.orientation) return this.cache.orientation;
...
JSM.Polygon2D.prototype.GetComplexity = function () {
  if (null !== this.cache.complexity) return this.cache.complexity;
  var a = this.vertices.length;
  if (3 > a) return JSM.Complexity.Invalid;
  var b = JSM.Complexity.Invalid;
  if (this.GetOrientation() != JSM.Orientation.Invalid) {
    var b = JSM.Complexity.Convex,
      c;
    for (c = 0; c < a; c++)
...
JSM.Polygon2D.prototype.GetVertexOrientation = function (a) {
  if (void 0 !== this.cache.vertexOrientations[a]) return this.cache.vertexOrientations[a];
  var b = this.vertices[this.GetPrevVertex(a)],
    c = this.vertices[a],
...
JSM.Polygon2D.prototype.CoordPosition = function (a) {
  function b(a, b, c) {
    ...
    JSM.IsEqual(b.y, a.y) || (g = Math.abs((b.y - a.y) / (c.y - b.y)), e.x = b.x + (c.x - b.x) * g);
    return JSM.IsLower(e.x, a.x) ? 0 : JSM.IsGreater(e.x, a.x) && (f || d) ? (a = JSM.IsGreater(c.y, b.y), f && a || d && !a ? 1 : 0) : 1
  }
  ...
  for (e = 0; e < c; e++) {
    ...
    h = h.CoordPosition(a);
    if (h == JSM.CoordSectorPosition2D.CoordInsideOfSector) return JSM.CoordPolygonPosition2D.OnEdge;
    if (h == JSM.CoordSectorPosition2D.CoordOnSectorEndCoord) return JSM.CoordPolygonPosition2D.OnVertex;
    d += b(a, f, g)
  }
...
JSM.Polygon2D.prototype.SectorPosition = function (a, b, c) {
  ...
  var f, g, h, k, l;
  for (f = 0; f < e; f++)
    if (g = f, h = (f + 1) % e, k = this.vertices[g], l = this.vertices[h], !(g == b || h == b || g == c || h == c)) {
      g = new JSM.Sector2D(k, l);
      g = a.SectorPosition(g);
      if (g == JSM.SectorSectorPosition2D.SectorsIntersectOnePoint) return JSM.SectorPolygonPosition2D.IntersectionOnePoint;
      if (g == JSM.SectorSectorPosition2D.SectorsIntersectCoincident) return JSM.SectorPolygonPosition2D.IntersectionCoincident;
...
JSM.Polygon2D.prototype.ToArray = function () {
  var a = [],
    b, c;
  for (b = 0; b < this.vertices.length; b++) c = this.vertices[b], a.push(c.Clone());
  return a
};
JSM.Polygon2D.prototype.FromArray = function (a) {
  this.Clear();
  var b, c;
  for (b = 0; b < a.length; b++) c = a[b], this.AddVertex(c.x, c.y)
};
JSM.Polygon2D.prototype.GetBoundingBox = function () {
  if (null !== this.cache.boundingBox) return this.cache.boundingBox;
  var a = new JSM.Box2D(new JSM.Coord2D(JSM.Inf, JSM.Inf), new JSM.Coord2D(-JSM.Inf, -JSM.Inf)),
    b, c;
  for (b = 0; b < this.vertices.length; b++) c = this.vertices[b], a.min.x = JSM.Minimum(a.min.x, c.x), a.min.y = JSM.Minimum(a.min.y, c.y), a.max.x = JSM.Maximum(a.max.x, c.x), a.max.y = JSM.Maximum(a.max.y, c.y);
...
JSM.Polygon2D.prototype.Clone = function () {
  var a = new JSM.Polygon2D,
    b, c;
  for (b = 0; b < this.vertices.length; b++) c = this.vertices[b], a.AddVertexCoord(c.Clone());
  return a
};
...
JSM.ContourPolygon2D.prototype.VertexCount = function () {
  var a = 0,
    b;
  for (b = 0; b < this.contours.length; b++) a += this.contours[b].VertexCount();
  return a
};
JSM.ContourPolygon2D.prototype.ReverseVertices = function () {
  var a;
  for (a = 0; a < this.contours.length; a++) this.contours[a].ReverseVertices()
};
...
JSM.ContourPolygon2D.prototype.GetSignedArea = function () {
  var a = 0,
    b;
  for (b = 0; b < this.contours.length; b++) a += this.contours[b].GetSignedArea();
  return a
};
...
JSM.ContourPolygon2D.prototype.GetOrientation = function () {
  if (null === this.lastContour) return JSM.Orientation.Invalid;
  var a = this.contours[0].GetOrientation();
  if (1 == this.contours.length) return a;
  if (a == JSM.Orientation.Invalid) return JSM.Orientation.Invalid;
  var b, c;
  for (b = 1; b < this.contours.length; b++)
    if (c = this.contours[b].GetOrientation(), c == JSM.Orientation.Invalid || a == c) return JSM.Orientation.Invalid;
  return a
};
JSM.ContourPolygon2D.prototype.GetComplexity = function () {
  if (null === this.lastContour) return JSM.Complexity.Invalid;
  if (1 == this.contours.length) return this.contours[0].GetComplexity();
  var a, b;
  for (a = 1; a < this.contours.length; a++)
    if (b = this.contours[a].GetComplexity(), b == JSM.Complexity.Invalid) return JSM.Complexity.Invalid;
...
JSM.ContourPolygon2D.prototype.ToArray = function () {
  ...
  for (b = 0; b < this.contours.length; b++) {
    d = this.contours[b];
    for (c = 0; c < d.VertexCount(); c++) e = d.GetVertex(c), a.push(e.Clone());
...
JSM.ContourPolygon2D.prototype.FromArray = function (a) {
  ...
  this.AddContour();
  var b, c;
  for (b = 0; b < a.length; b++) c = a[b], null === c ? this.AddContour() : this.AddVertex(c.x, c.y)
};
...
JSM.ContourPolygon2D.prototype.Clone = function () {
  var a = new JSM.ContourPolygon2D,
    b, c;
  for (b = 0; b < this.contours.length; b++) c = this.contours[b], a.AddContour(c.Clone());
  return a
};
...
JSM.Polygon.prototype.GetNormal = function () {
  if (null !== this.cache.normal) return this.cache.normal;
...
JSM.Polygon.prototype.ToPolygon2D = function () {
  var a = this.GetNormal(),
    b = new JSM.Polygon2D,
    c, d;
  for (c = 0; c < this.vertices.length; c++) d = this.vertices[c].ToCoord2D(a), b.AddVertex(d.x, d.y);
  return b
};
...
JSM.Polygon.prototype.FromArray = function (a) {
  this.Clear();
  var b, c;
  for (b = 0; b < a.length; b++) c = a[b], this.AddVertex(c.x, c.y, c.z)
};
...
JSM.ContourPolygon.prototype.ToContourPolygon2D = function () {
  var a = this.contours[0].GetNormal(),
    b = new JSM.ContourPolygon2D,
    c, d, e, f;
  for (c = 0; c < this.contours.length; c++) {
    b.AddContour();
    e = this.contours[c];
    for (d = 0; d < e.VertexCount(); d++) f = e.GetVertex(d), b.AddVertexCoord(f.ToCoord2D(a))
  }
  return b
};
...
JSM.ContourPolygon.prototype.FromArray = function (a) {
  ...
  this.AddContour();
  var b, c;
  for (b = 0; b < a.length; b++) c = a[b], null === c ? this.AddContour() : this.AddVertex(c.x, c.y, c.z)
};
...
JSM.OffsetPolygonContour = function (a, b) {
  var c = a.VertexCount(),
    d = a.GetNormal(),
    e, f, g, h, k, l = new JSM.Polygon,
    m;
  for (m = 0; m < c; m++) e = a.GetPrevVertex(m), f = m, g = a.GetNextVertex(m), e = a.GetVertex(e), f = a.GetVertex(f), h = a.GetVertex(g), k = JSM.CoordSub(e, f), g = JSM.CoordSub(h, f), k = k.AngleTo(g) / 2, JSM.CoordOrientation(e, f, h, d) == JSM.Orientation.Clockwise && (k = Math.PI - k), e = b / Math.sin(k), h = f.Clone(), h.Offset(g, e), h.Rotate(d, k, f), l.AddVertex(h.x, h.y, h.z);
  return l
};
JSM.CutVertexType = {
  Left: 1,
...
JSM.PolygonCutter.prototype.Cut = function (a, b, c, d) {
  ...
  return null !== e ? (a = a.Clone(), e == JSM.CutVertexType.Left ? b.push(a) : e == JSM.CutVertexType.Right ? c.push(a) : d.push(a), !0) : !this.CalculateCutPolygonData() || !this.CalculateEntryVertices() || !this.CalculateCuttedPolygons(b, c) ? !1 : !0
};
...
JSM.PolygonCutter.prototype.CalculateOriginalPolygonData = function (a) {
  ...
  var b = !1,
    c = !1,
    d, e;
  for (d = 0; d < this.originalPolygon.VertexCount(); d++) e = a.GetVertex(d), e = this.geometryInterface.getVertexSide(e), e == JSM.CutVertexType.Left ? b = !0 : e == JSM.CutVertexType.Right && (c = !0), this.originalPolygonVertexTypes.push(e);
...
JSM.PolygonCutter.prototype.CalculateCutPolygonData = function () {
  ...
  function c(a, c) {
    var d = a.originalPolygon.GetPrevVertex(c),
      ...
      d = a.geometryInterface.getIntersectionVertex(d,
        e);
    if (null === d) return !1;
  ...
  var e = this.originalPolygon.VertexCount(),
    f, g, h, k;
  for (f = 0; f <= e; f++) g =
    f === e, h = f, g && (h = 0), k = this.originalPolygonVertexTypes[h], a(this.cutPolygonVertexTypes, k) && c(this, h), g || d(this, h, k);
...
JSM.PolygonCutter.prototype.CalculateEntryVertices = function () {
  function a(a, b, c) {
    if (a[c] != JSM.CutVertexType.Cut) return 0;
    ...
    if (l == JSM.CutVertexType.Right) {
      if (a == JSM.CutVertexType.Left || a == JSM.CutVertexType.Cut && JSM.IsLowerOrEqual(c, b)) return 1
    } else if (l == JSM.CutVertexType.Left) {
      if (a == JSM.CutVertexType.Right || a == JSM.CutVertexType.Cut && JSM.IsGreaterOrEqual(c, b)) return -1
    } else if (l == JSM.CutVertexType.Cut)
      if (a ==
        JSM.CutVertexType.Left) {
        if (JSM.IsLowerOrEqual(c, d)) return 1
      } else if (a == JSM.CutVertexType.Right && JSM.IsGreaterOrEqual(c, d)) return -1;
    return 0
  }
  this.entryVertices = [];
  this.entryVertexTypes = [];
  var b, c, d;
  for (b = 0; b < this.cutVertexIndices.length; b++) c = this.cutVertexIndices[b], d = a(this.cutPolygonVertexTypes, this.cutPolygonVertexDistances, c), 0 !== d && (this.entryVertices.push(c), this.entryVertexTypes.push(d));
...
JSM.PolygonCutter.prototype.CalculateCuttedPolygons = function (a, b) {
  function c(a, b, c, g) {
    function h(a, b, c) {
      return -1 != c[a] ? (b = c[a], c[c[a]] = -1, c[a] = -1, b) : JSM.NextIndex(a, b.VertexCount())
    }
    ...
    var l = function (a, b, c) {
      var d = [],
        e;
      for (e = 0; e < a.VertexCount(); e++) d.push(-1);
      var f;
      for (e = 0; e < b.length; e++)
        if (-1 == d[b[e]]) {
          ...
          if (-1 == f) return null;a = d;
          var g = b,
            h = e;a[g[h]] = g[f];a[g[f]] = g[h]
        } return d
    }(a.cutPolygon, a.entryVertices, a.entryVertexTypes);
    if (null === l) return !1;
    for (var m = g ? a.entryVertices.length - 1 : 0; 0 <= m && m < a.entryVertices.length;) k(a, l, m, b, c), m = g ? m - 1 : m + 1;
    return !0
  }
...
JSM.CutPolygon2DWithLine = function (a, b, c, d, e) {
  return (new JSM.PolygonCutter({
    ...
    getIntersectionVertex: function (a, c) {
      ...
      return b.LinePosition(d, e) != JSM.LineLinePosition2D.LinesIntersectsOnePoint ?
        null : e
    },
    getVertexDistances: function (a) {
      for (var c = new JSM.Coord2D(0, 0), d = b.start.Clone(), c = b.direction.Clone().Rotate(-Math.PI / 2, c), d = new JSM.Line2D(d, c), e, l = [], c = 0; c < a.VertexCount(); c++) e = a.GetVertex(c), l.push(d.CoordSignedDistance(e));
      return l
    }
  })).Cut(a, c, d, e)
};
  ...
  return (new JSM.PolygonCutter({
    ...
    getIntersectionVertex: function (a, c) {
      var d = new JSM.Line(c, JSM.CoordSub(c, a)),
        e = new JSM.Coord(0, 0, 0);
      return b.LinePosition(d, e) != JSM.LinePlanePosition.LineIntersectsPlane ?
        null : e
    },
    getVertexDistances: function (a) {
      for (var c = a.GetNormal(), d = new JSM.Vector(b.a, b.b, b.c), c = JSM.VectorCross(d, c), d = a.GetVertex(0), c = JSM.GetPlaneFromCoordAndDirection(d, c), e, l = [], d = 0; d < a.VertexCount(); d++) e = a.GetVertex(d), l.push(c.CoordSignedDistance(e));
      return l
    }
  })).Cut(a, c, d, e)
};
    ...
    for (h = 1; h < c; h++) {
      ...
      for (k = 0; k < a.length; k++) {
        ...
        if (JSM.CutPolygon2DWithLine(a[k], l, x, A, [])) {
          for (var E = void 0, E = 0; E < x.length; E++) C.push(x[E]);
          for (E = 0; E < A.length; E++) w.push(A[E])
        }
      }
      a = B
    }
    for (k = 0; k < a.length; k++) b.push(a[k])
  }
...
JSM.ConvertContourPolygonToPolygon2D = function (a, b) {
  ...
  function d(a, b, d, e, f) {
    f = function (a, b, c, d) {
      function e(a, b, c, d, f) {
        ...
        for (b = 1; b < a.ContourCount(); b++)
          if (void 0 === f.addedHoles[b] && (h = a.GetContour(b), g(h, c, d))) return !1;
        return !0
      }
      ...
      function f(a, b) {
        ...
        for (c = 0; c < b.entryPositions.length; c++)
          if (a.IsEqual(b.entryPositions[c])) return !0;
        return !1
      }
      c = a.GetContour(c);
      var g, h, k, l;
      for (g = 0; g < b.VertexCount(); g++)
        for (h = 0; h < c.VertexCount(); h++)
          if (k = b.GetVertex(g), l = c.GetVertex(h), e(a, b, k, l, d) && !f(k, d) && !f(l, d)) return d.entryPositions.push(k.Clone()), d.entryPositions.push(l.Clone()), {
            beg: g,
            end: h
          };
      return null
    ...
    (function (a, b, d, e, f) {
      ...
      var k = 0,
        l = 0;
      void 0 !== f && null !== f && (k = f[h][0], l = f[h][1], JSM.ShiftArray(f, h + 1));
      e = e.end;
      h = g.GetPrevVertex(e);
  ...
  var e = a.ContourCount(),
    f = a.GetContour(0),
    g = new JSM.Polygon2D,
    h, k;
  for (h = 0; h < f.VertexCount(); h++) k = f.GetVertex(h), c(g, k.Clone(), b, 0, h);
  if (1 == e) return g;
  f = [];
  for (h = 1; h < e; h++) f.push(h);
  for (e = {
      addedHoles: {},
      holeTryouts: {},
      entryPositions: []
    ...
    if (h =
      f.shift(), d(a, g, h, b, e)) e.addedHoles[h] = !0;
    else {
      void 0 === e.holeTryouts[h] && (e.holeTryouts[h] = 0);
      e.holeTryouts[h] += 1;
      if (10 < e.holeTryouts[h]) return null;
      f.push(h)
    } return g
};
JSM.TriangulateConvexPolygon = function (a) {
  var b = [],
    c;
  for (c = 1; c < a.VertexCount() - 1; c++) b.push([0, c, c + 1]);
  return b
};
JSM.TriangulateConcavePolygon2D = function (a) {
  function b(a) {
    ...
    for (c = 0; c < b; c++)
      for (d = 0; d < b; d++)
        if (c != d && a.IsDiagonal(c, d)) return {
          beg: c,
          end: d
        };
    return null
  ...
  for (var f; 0 < d.length;)
    if (e = d.pop(), f = e.polygon.VertexCount(), !(3 > f))
      if (3 == f) a.push(e.map);
      else {
        f = b(e.polygon);
...
JSM.TraverseOctreeNodes = function (a, b) {
  function c(a, b) {
    if (b(a) && null !== a.children) {
      var f, g;
      for (f = 0; f < a.children.length; f++) g = a.children[f], c(g, b)
    }
  }
  c(a.root, b)
};
...
JSM.Octree = function (a, b) {
  ...
  if (void 0 === this.maxCoordNumInNodes || null === this.maxCoordNumInNodes || 0 === this.maxCoordNumInNodes) this.maxCoordNumInNodes = 50
};
...
JSM.Octree.prototype.FindCoordInNode = function (a, b) {
  ...
  for (c = 0; c < b.coords.length; c++)
    if (d = b.coords[c], a.IsEqual(this.coords[d])) return d;
  return -1
};
JSM.Octree.prototype.AddCoordToNode = function (a, b) {
  ...
  if (-1 != d) return d;
  if (c.coords.length >= this.maxCoordNumInNodes && this.SplitNode(c)) return this.AddCoordToNode(a, c);
...
JSM.Octree.prototype.FindNodeForCoord = function (a, b) {
  if (null === b.children) return b;
  var c = b.box.GetCenter(),
    d = a.x > c.x,
    e = a.y > c.y,
    c = a.z > c.z;
  return !d && !e && !c ? this.FindNodeForCoord(a, b.children[0]) : d && !e && !c ? this.FindNodeForCoord(a, b.children[1]) : d && e && !c ? this.FindNodeForCoord(a, b.children[2]) : !d && e && !c ? this.FindNodeForCoord(a, b.children[3]) : !d && !e && c ? this.FindNodeForCoord(a, b.children[4]) : d && !e && c ? this.FindNodeForCoord(a, b.children[5]) : d && e && c ? this.FindNodeForCoord(a, b.children[6]) : !d && e && c ? this.FindNodeForCoord(a,
    b.children[7]) : null
};
JSM.Octree.prototype.SplitNode = function (a) {
  ...
  a.coords = [];
  var d, e;
  for (d = 0; d < c.length; d++) e = this.FindNodeForCoord(this.coords[c[d]], a), e.coords.push(c[d]);
  return !0
};
...
JSM.TriangleOctree.prototype.AddTriangleToNode = function (a, b, c, d, e) {
  if (!d.box.IsCoordInside(a) || !d.box.IsCoordInside(b) || !d.box.IsCoordInside(c)) return !1;
  if (null === d.children) {
    var f = this;
  ...
  if (null !== d.children) {
    ...
    for (g = 0; g < d.children.length; g++)
      if (h = d.children[g], this.AddTriangleToNode(a, b, c, h, e)) return !0
  }
  d.triangles.push({
    v0: a,
    v1: b,
...
JSM.BSPTree.prototype.TraverseNode = function (a, b) {
  null !== a && (b(a), this.TraverseNode(a.inside, b), this.TraverseNode(a.outside, b))
};
...
JSM.BSPTree.prototype.AddPolygonToNode = function (a, b, c) {
  ...
  if (null === a.polygon) {
    ...
    var f = [],
      e = [];
    JSM.CutPolygonWithPlane(b, a.plane, f, d, e) && (0 < d.length && this.AddInsidePolygonsToNode(a, d, c), 0 < f.length && this.AddOutsidePolygonsToNode(a, f, c), 0 < e.length && (d = b.GetNormal(), 0 < JSM.VectorDot(d, a.plane.GetNormal()) ? this.AddInsidePolygonsToNode(a, e, c) :
      this.AddOutsidePolygonsToNode(a, e, c)))
  }
  return !0
};
JSM.BSPTree.prototype.AddInsidePolygonsToNode = function (a, b, c) {
  null === a.inside && (a.inside = this.CreateNewNode(), a.inside.parent = a);
  var d;
  for (d = 0; d < b.length; d++) this.AddPolygonToNode(a.inside, b[d], c)
};
JSM.BSPTree.prototype.AddOutsidePolygonsToNode = function (a, b, c) {
  null === a.outside && (a.outside = this.CreateNewNode(), a.outside.parent = a);
  var d;
  for (d = 0; d < b.length; d++) this.AddPolygonToNode(a.outside, b[d], c)
};
...
JSM.ClipPolygonWithBSPTree = function (a, b, c, d, e, f) {
  function g(a, b, c) {
    if (null !== b) {
      var d = [],
        e = [],
        f = [];
      JSM.CutPolygonWithPlane(a, b.plane, e, d, f) && (0 < d.length && k(b, d, c), 0 < e.length && l(b, e, c), 0 < f.length && (a = a.GetNormal(), 0 < JSM.VectorDot(a, b.plane.GetNormal()) ? k(b, f, !0) : l(b, f, !0)))
    }
  }
  ...
  function k(a, b, c) {
    if (null !== a.inside) {
      a = a.inside;
      var e;
      for (e = 0; e < b.length; e++) g(b[e], a, c)
    } else h(b, c ? f : d)
  }
...
JSM.TraverseBSPTreeForEyePosition = function (a, b, c) {
  function d(a) {
    if (null !== a) {
      ...
      f == JSM.CoordPlanePosition.CoordInFrontOfPlane ? (d(a.inside), c(a), d(a.outside)) : (f == JSM.CoordPlanePosition.CoordAtBackOfPlane ? (d(a.outside), c(a)) : d(a.outside), d(a.inside))
    }
  }
  d(a.root)
};
...
JSM.GenerateBezierCurve = function (a, b) {
  ...
  for (f = 0; f <= b; f++) {
    ...
    for (g = 0; g <= d; g++) k = a[g], l = JSM.BernsteinPolynomial(g, d, h), m.x += k.x * l, m.y += k.y * l;
    c.push(m)
  }
  return c
};
...
JSM.GenerateCirclePoints = function (a, b, c) {
  var d = [],
    ...
    f = 2 * Math.PI / b,
    g, h;
  for (g = 0; g < b; g++) h = JSM.CylindricalToCartesian(a, 0, e), void 0 !== c && null !== c && (h = JSM.CoordAdd(h, c)), d.push(h), e += f;
  return d
};
JSM.GetRuledMesh = function (a, b, c, d, e) {
  if (a.length === b.length) {
    var f = a.length - 1,
      ...
      h = [],
      k;
    for (k = 0; k <= f; k++) g.push(JSM.CoordSub(b[k], a[k])), h.push(a[k].DistanceTo(b[k]));
    var l, m;
    for (k = 0; k <= f; k++) {
      l = h[k] / c;
      for (b = 0; b <= c; b++) m = a[k].Clone().Offset(g[k], l * b), d.push(m)
    }
    for (k = 0; k < f; k++)
      for (b = 0; b < c; b++) a = k * (c + 1) + b, d = a + 1, g = a + c + 1, h = g + 1, a = [a, g, h, d], e.push(a)
  }
};
...
JSM.Path2D.prototype.CubicBezierTo = function (a, b, c, d, e, f) {
  ...
  for (b = 1; b < a.length; b++) this.LineTo(a[b].x, a[b].y)
};
JSM.Path2D.prototype.Close = function () {
  function a(a) {
    if (0 === a.VertexCount()) return !1;
  ...
  function b(a, b) {
    ...
    for (c = a.length - 1; 0 <= c; c--) {
      g = a[c].GetContour(0);
      a: {
        var l = b;h = g.GetOrientation();k = l.GetOrientation();
        if (h !== k && (h = l.GetVertex(0), g.CoordPosition(h) == JSM.CoordPolygonPosition2D.Inside)) {
          g = !0;
          break a
        }
        g = !1
  ...
  if (null !== this.currentPolygon) {
    if (a(this.currentPolygon)) {
      var c =
        b(this.polygons, this.currentPolygon);
      null === c ? (c = new JSM.ContourPolygon2D, c.AddContour(this.currentPolygon), this.polygons.push(c)) : c.AddContour(this.currentPolygon)
    }
    this.currentPolygon = null
  }
};
...
JSM.HexColorToRGBComponents = function (a) {
  for (var b = a.toString(16); 6 > b.length;) b = "0" + b;
...
JSM.RGBComponentsToHexColor = function (a, b, c) {
  function d(a) {
    for (a = parseInt(a, 10).toString(16); 2 > a.length;) a = "0" + a;
    return a
  }
  a = d(a);
  b = d(b);
...
JSM.BodyPolygon.prototype.Clone = function () {
  var a = new JSM.BodyPolygon([]),
    b;
  for (b = 0; b < this.vertices.length; b++) a.vertices.push(this.vertices[b]);
  a.material = this.material;
...
JSM.Body.prototype.SetPointsMaterialIndex = function (a) {
  var b;
  for (b = 0; b < this.points.length; b++) this.points[b].SetMaterialIndex(a)
};
JSM.Body.prototype.SetLinesMaterialIndex = function (a) {
  var b;
  for (b = 0; b < this.lines.length; b++) this.lines[b].SetMaterialIndex(a)
};
JSM.Body.prototype.SetPolygonsMaterialIndex = function (a) {
  var b;
  for (b = 0; b < this.polygons.length; b++) this.polygons[b].SetMaterialIndex(a)
};
JSM.Body.prototype.SetPolygonsCurveGroup = function (a) {
  var b;
  for (b = 0; b < this.polygons.length; b++) this.polygons[b].SetCurveGroup(a)
};
JSM.Body.prototype.RemoveVertex = function (a) {
  var b = [],
    ...
    d = [],
    e, f, g, h;
  for (e = 0; e < this.points.length; e++) f = this.points[e], f.GetVertexIndex() == a ? b.push(e) : f.GetVertexIndex() >= a && f.SetVertexIndex(f.GetVertexIndex() - 1);
  for (e = 0; e < this.lines.length; e++) f = this.lines[e], f.GetBegVertexIndex() == a || f.GetEndVertexIndex() == a ? c.push(e) : (f.GetBegVertexIndex() >= a && f.SetBegVertexIndex(f.GetBegVertexIndex() - 1), f.GetEndVertexIndex() >= a && f.SetEndVertexIndex(f.GetEndVertexIndex() - 1));
  for (e = 0; e < this.polygons.length; e++) {
    g =
      this.polygons[e];
    for (f = 0; f < g.VertexIndexCount(); f++)
      if (h = g.GetVertexIndex(f), g.GetVertexIndex(f) == a) {
        d.push(e);
        break
      } else h >= a && g.SetVertexIndex(f, h - 1)
  }
  for (e = 0; e < b.length; e++) this.RemovePoint(b[e] - e);
  for (e = 0; e < c.length; e++) this.RemoveLine(c[e] - e);
  for (e = 0; e < d.length; e++) this.RemovePolygon(d[e] - e);
  this.vertices.splice(a, 1)
};
...
JSM.Body.prototype.Transform = function (a) {
  var b;
  for (b = 0; b < this.vertices.length; b++) this.vertices[b].position = a.Apply(this.vertices[b].position);
...
JSM.Body.prototype.GetBoundingBox = function () {
  var a = new JSM.Coord(JSM.Inf, JSM.Inf, JSM.Inf),
    ...
    c, d;
  for (c = 0; c < this.vertices.length; c++) d = this.vertices[c].position, a.x = JSM.Minimum(a.x, d.x), a.y = JSM.Minimum(a.y, d.y), a.z = JSM.Minimum(a.z, d.z), b.x = JSM.Maximum(b.x, d.x), b.y = JSM.Maximum(b.y, d.y), b.z = JSM.Maximum(b.z, d.z);
...
JSM.Body.prototype.GetBoundingSphere = function () {
  var a = this.GetCenter(),
    b = 0,
    c, d;
  for (c = 0; c < this.vertices.length; c++) d = a.DistanceTo(this.vertices[c].position), JSM.IsGreater(d, b) && (b = d);
...
JSM.Body.prototype.OffsetToOrigo = function () {
  ...
  a.MultiplyScalar(-1);
  var b;
  for (b = 0; b < this.vertices.length; b++) this.vertices[b].position = JSM.CoordAdd(this.vertices[b].position, a)
};
JSM.Body.prototype.Merge = function (a) {
  var b = this.vertices.length,
    c, d;
  for (c = 0; c < a.VertexCount(); c++) this.vertices.push(a.GetVertex(c).Clone());
  for (c = 0; c < a.PointCount(); c++) d = a.GetPoint(c).Clone(), d.SetVertexIndex(d.GetVertexIndex() + b), this.points.push(d);
  for (c = 0; c < a.LineCount(); c++) d = a.GetLine(c).Clone(), d.SetBegVertexIndex(d.GetBegVertexIndex() + b), d.SetEndVertexIndex(d.GetEndVertexIndex() + b), this.lines.push(d);
  var e;
  for (c = 0; c < a.PolygonCount(); c++) {
    e = a.GetPolygon(c).Clone();
    for (d = 0; d < e.VertexIndexCount(); d++) e.vertices[d] +=
      b;
...
JSM.Body.prototype.Clone = function () {
  var a = new JSM.Body,
    b;
  for (b = 0; b < this.vertices.length; b++) a.AddVertex(this.vertices[b].Clone());
  for (b = 0; b < this.points.length; b++) a.AddPoint(this.points[b].Clone());
  for (b = 0; b < this.lines.length; b++) a.AddLine(this.lines[b].Clone());
  for (b = 0; b < this.polygons.length; b++) a.AddPolygon(this.polygons[b].Clone());
...
JSM.Model.prototype.AddBodies = function (a) {
  var b, c;
  for (b = 0; b < a.length; b++) c = a[b], this.AddBody(c)
};
...
JSM.Model.prototype.VertexCount = function () {
  var a = 0,
    b;
  for (b = 0; b < this.bodies.length; b++) a += this.bodies[b].VertexCount();
  return a
};
JSM.Model.prototype.PolygonCount = function () {
  var a = 0,
    b;
  for (b = 0; b < this.bodies.length; b++) a += this.bodies[b].PolygonCount();
  return a
};
...
JSM.AdjacencyInfo.prototype.Calculate = function (a) {
  ...
  function c(a, b, c) {
    function d(a, b, c, e, f) {
      var g = new JSM.PolyEdgeInfo,
        h, k;
      for (h = 0; h < a.edges.length; h++) k = a.edges[h], k.vert1 === c && k.vert2 === e ? (g.index = h, g.reverse = !1) : k.vert1 === e && k.vert2 === c && (g.index = h, g.reverse = !0); - 1 === g.index ? (h = new JSM.EdgeInfo, h.vert1 = c, h.vert2 = e, h.pgon1 = f, h.pgon2 = -1, a.edges.push(h), g.index = a.edges.length - 1, g.reverse = !1) : (h = a.edges[g.index], -1 === h.pgon1 ? h.pgon1 = f : h.pgon1 !== f &&
        -1 === h.pgon2 && (h.pgon2 = f));
      (function (a, b, c, d, e, f) {
        function g(a, b, c) {
          -1 == a.edges.indexOf(c) && a.edges.push(c); - 1 == a.pgons.indexOf(b) && a.pgons.push(b)
        }
        f.verts.push(c);
        f.pedges.push(e);
    ...
    b = b.GetPolygon(c);
    var k = new JSM.PgonInfo,
      l, m, n, q = b.VertexIndexCount();
    for (l = 0; l < q; l++) m = b.GetVertexIndex(l), n = b.GetVertexIndex(l < q - 1 ? l + 1 : 0), d(a, k, m, n, c);
    a.pgons.push(k)
  }
  this.verts = [];
  this.edges = [];
  this.pgons = [];
  var d;
  for (d = 0; d < a.VertexCount(); d++) b(this);
  for (d =
    0; d < a.PolygonCount(); d++) c(this, a, d)
};
JSM.AdjacencyInfo.prototype.IsContourVertex = function (a) {
  var b, c;
  for (b = 0; b < a.edges.length; b++)
    if (c = a.edges[b], this.IsContourEdge(this.edges[c])) return !0;
  return !1
};
...
JSM.AdjacencyInfo.prototype.GetEdgePolygonCount = function (a) {
  var b = 0; - 1 != a.pgon1 && (b += 1); - 1 != a.pgon2 && (b += 2);
  return b
};
...
JSM.CalculateBodyVertexToPolygon = function (a) {
  var b = [],
    c, d;
  for (c = 0; c < a.VertexCount(); c++) b.push([]);
  var e;
  for (c = 0; c < a.PolygonCount(); c++) {
    e = a.GetPolygon(c);
    for (d = 0; d < e.VertexIndexCount(); d++) b[e.GetVertexIndex(d)].push(c)
  }
  return b
};
JSM.IsSolidBody = function (a) {
  a = new JSM.AdjacencyInfo(a);
  if (0 === a.edges.length) return !1;
  var b, c;
  for (b = 0; b < a.edges.length; b++)
    if (c = a.edges[b], -1 === c.pgon1 || -1 === c.pgon2) return !1;
  return !0
};
JSM.CheckSolidBody = function (a) {
  ...
  for (b = 0; b < a.edges.length; b++) {
    d = a.edges[b];
    if (-1 === d.pgon1 || -1 === d.pgon2) return !1;
    g = a.pgons[d.pgon1];
    f = !1;
    for (c = 0; c < g.pedges.length; c++)
      if (e = g.pedges[c], e.index == b) {
        h = e.reverse;
        f = !0;
        break
      } if (!f) return !1;
...
JSM.TraversePgonsAlongEdges = function (a, b, c) {
  ...
  for (var e; 0 < a.length;)
    if (e = a.pop(), !d[e] && (d[e] = !0, c(e)))
      for (var f = b, g = a, h = f.pgons[e], k = void 0, l = void 0, l = void 0, k = 0; k < h.pedges.length; k++) l = f.edges[h.pedges[k].index], l = f.GetAnotherPgonOfEdge(l, e), -1 != l && g.push(l)
};
...
JSM.CheckBody = function (a) {
  ...
  for (c = 0; c < a.PointCount(); c++)
    if (d = a.GetPoint(c), 0 > d.GetVertexIndex() || d.GetVertexIndex() >= b) return !1;
  for (c = 0; c < a.LineCount(); c++)
    if (d = a.GetLine(c), 0 > d.GetBegVertexIndex() || d.GetBegVertexIndex() >= b || 0 > d.GetEndVertexIndex() || d.GetEndVertexIndex() >= b) return !1;
  for (c = 0; c < a.PolygonCount(); c++) {
    e = a.GetPolygon(c);
    if (3 > e.VertexIndexCount()) return !1;
    for (d = 0; d < e.VertexIndexCount(); d++)
      if (0 > e.GetVertexIndex(d) || e.GetVertexIndex(d) >= b) return !1
  }
  return !0
};
JSM.CalculateBodyPolygonNormal = function (a, b) {
  ...
  if (3 <= d) {
    var f, g, h;
    for (f = 0; f < d; f++) g = f, h = (f + 1) % d, g = a.GetVertexPosition(c.GetVertexIndex(g)), h = a.GetVertexPosition(c.GetVertexIndex(h)), e.x += (g.y - h.y) * (g.z + h.z), e.y += (g.z - h.z) * (g.x + h.x), e.z += (g.x - h.x) * (g.y + h.y)
  }
  e.Normalize();
  return e
};
JSM.CalculateBodyPolygonNormals = function (a) {
  var b = [],
    c;
  for (c = 0; c < a.PolygonCount(); c++) b.push(JSM.CalculateBodyPolygonNormal(a, c));
  return b
};
JSM.CalculateBodyVertexNormals = function (a) {
  var b = [],
    c = JSM.CalculateBodyPolygonNormals(a),
    d = null,
    e, f, g, h, k, l, m, n;
  for (e = 0; e < a.PolygonCount(); e++)
    if (h = a.GetPolygon(e), b[e] = [], h.HasCurveGroup()) {
      null === d && (d = JSM.CalculateBodyVertexToPolygon(a));
      for (f = 0; f < h.VertexIndexCount(); f++) {
        k = new JSM.Vector(0, 0, 0);
        l = 0;
        m = d[h.GetVertexIndex(f)];
        for (g = 0; g < m.length; g++) n = a.GetPolygon(m[g]), n.GetCurveGroup() === h.GetCurveGroup() && (k = JSM.CoordAdd(k, c[m[g]]), l++);
      ...
      g =
        c[e];
      for (f = 0; f < h.VertexIndexCount(); f++) b[e].push(new JSM.Vector(g.x, g.y, g.z))
    } return b
};
JSM.CalculatePolygonCurveGroups = function (a, b) {
  var c = [],
    d = a.VertexCount(),
    e, f;
  for (e = 0; e < d; e++) c.push(0);
  for (e = 0; e < d; e++) f = c[a.GetPrevVertex(e)], a.GetVertexAngle(e) > b ? c[e] = f : c[e] = f + 1;
  f = c[0];
  d = c[d - 1];
  if (0 === f && f != d)
    for (e = 0; c[e] == f; e++) c[e] = d;
  return c
};
JSM.CalculatePolygonCentroid = function (a, b) {
  var c = a.GetPolygon(b),
    ...
    e = new JSM.Coord(0, 0, 0),
    f;
  for (f = 0; f < d; f++) e = JSM.CoordAdd(e, a.GetVertexPosition(c.GetVertexIndex(f)));
  e.MultiplyScalar(1 / d);
  return e
};
JSM.MakeBodyInsideOut = function (a) {
  var b, c;
  for (b = 0; b < a.PolygonCount(); b++) c = a.GetPolygon(b), c.ReverseVertexIndices()
};
JSM.SoftMoveBodyVertex = function (a, b, c, d, e) {
  b = a.GetVertexPosition(b).Clone();
  var f = JSM.GetGaussianCParameter(c, e, 0, 1E-5),
    g, h;
  for (g = 0; g < a.VertexCount(); g++) h = b.DistanceTo(a.GetVertex(g).position), JSM.IsGreater(h, c) || (h = JSM.GetGaussianValue(h, e, 0, f), a.GetVertexPosition(g).Offset(d, h))
};
JSM.GenerateWireBody = function (a) {
  var b = new JSM.Body,
    c;
  for (c = 0; c < a.VertexCount(); c++) b.AddVertex(a.GetVertex(c).Clone());
  a = new JSM.AdjacencyInfo(a);
  var d;
  for (c = 0; c < a.edges.length; c++) d = a.edges[c], JSM.AddLineToBody(b, d.vert1, d.vert2);
  return b
};
JSM.TriangulateWithCentroids = function (a) {
  var b = a.PolygonCount(),
    c, d, e, f, g, h, k;
  for (c = 0; c < b; c++) {
    ...
    for (d = 0; d < g; d++) h = f.GetVertexIndex(d), k = f.GetVertexIndex(d < g - 1 ? d + 1 : 0), h = new JSM.BodyPolygon([h, k, e]), h.InheritAttributes(f), a.AddPolygon(h)
  }
  for (c = 0; c < b; c++) a.RemovePolygon(0)
};
JSM.TriangulatePolygons = function (a) {
  ...
  for (c = 0; c < b; c++) {
    e = a.GetPolygon(c);
    f = new JSM.Polygon;
    for (d = 0; d < e.VertexIndexCount(); d++) g = a.GetVertexPosition(e.GetVertexIndex(d)), f.AddVertex(g.x, g.y, g.z);
    f = JSM.TriangulatePolygon(f);
    if (null !== f)
      for (d = 0; d < f.length; d++) g = f[d], g = new JSM.BodyPolygon([e.GetVertexIndex(g[0]), e.GetVertexIndex(g[1]), e.GetVertexIndex(g[2])]), g.InheritAttributes(e), a.AddPolygon(g)
  }
  for (c = 0; c < b; c++) a.RemovePolygon(0)
};
JSM.GenerateRandomMaterials = function (a, b, c) {
  ...
  var e, f, g = 0;
  for (e = 0; e < a.LineCount(); e++) f = d(c, g++), f = b.AddMaterial(new JSM.Material({
    ambient: f,
    diffuse: f
  })), a.GetLine(e).SetMaterialIndex(f);
  for (e = 0; e < a.PointCount(); e++) f = d(c, g++), f = b.AddMaterial(new JSM.Material({
    ambient: f,
    diffuse: f
  })), a.GetPoint(e).SetMaterialIndex(f);
  for (e = 0; e < a.PolygonCount(); e++) f = d(c, g++), f = b.AddMaterial(new JSM.Material({
    ambient: f,
    diffuse: f
...
JSM.AddBodyToBSPTree = function (a, b, c) {
  ...
  for (d = 0; d < a.PolygonCount(); d++) {
    ...
    for (var g = new JSM.Polygon, k = void 0, l = void 0, k = 0; k < h.VertexIndexCount(); k++) l = e.GetVertexPosition(h.GetVertexIndex(k)), g.AddVertex(l.x, l.y, l.z);
    e = g;
    b.AddPolygon(e, f)
  }
};
...
JSM.CalculateCubicTextureCoord = function (a, b, c) {
  var d = new JSM.Coord2D(0, 0),
    e = c.e1.Clone().Normalize(),
    f = c.e2.Clone().Normalize(),
    g = c.e3.Clone().Normalize(),
    h = -1,
    k = 0,
    l, m, n;
  for (l = 0; 3 > l; l++) 0 === l ? m = e : 1 === l ? m = f : 2 === l && (m = g), n = Math.abs(JSM.VectorDot(b, m)), JSM.IsGreater(n, k) && (h = l, k = n);
  if (-1 === h) return d;
  b = null;
  ...
  return null ===
    b ? d : JSM.CalculatePlanarTextureCoord(a, b)
};
JSM.CalculateCylindricalTextureCoord = function (a, b, c) {
  var d = new JSM.Coord2D(0, 0),
    e = c.e3.Clone().Normalize();
  if (e.IsCollinearWith(b)) return d = JSM.CalculateCubicTextureCoord(a, b, c), [d, 0];
...
JSM.CalculatePolygonPlanarTextureCoords = function (a, b) {
  var c = [],
    d = a.GetPolygon(b),
    e = a.GetTextureProjection().GetCoords(),
    f, g;
  for (f = 0; f < d.VertexIndexCount(); f++) g = a.GetVertexPosition(d.GetVertexIndex(f)), c.push(JSM.CalculatePlanarTextureCoord(g, e));
  return c
};
JSM.CalculatePolygonCubicTextureCoords = function (a, b, c) {
  var d = [];
  b = a.GetPolygon(b);
  var e = a.GetTextureProjection().GetCoords(),
    f, g;
  for (f = 0; f < b.VertexIndexCount(); f++) g = a.GetVertexPosition(b.GetVertexIndex(f)), d.push(JSM.CalculateCubicTextureCoord(g, c, e));
  return d
};
JSM.CalculatePolygonCylindricalTextureCoords = function (a, b, c) {
  var d = [],
    e = [],
    f = a.GetPolygon(b),
    g = a.GetTextureProjection().GetCoords(),
    h;
  for (b = 0; b < f.VertexIndexCount(); b++) h = a.GetVertexPosition(f.GetVertexIndex(b)), h = JSM.CalculateCylindricalTextureCoord(h, c, g), d.push(h[0]), e.push(h[1]);
  if (g.e3.Clone().Normalize().IsCollinearWith(c)) return d;
  c = !1;
  ...
  if (c) {
    g = g.e1.Length();
    for (b = 0; b < e.length; b++) JSM.IsLower(e[b],
      Math.PI) && (d[b].x = g * (e[b] + 2 * Math.PI))
  }
  return d
};
JSM.CalculateBodyPlanarTextureCoords = function (a) {
  var b = [],
    c;
  for (c = 0; c < a.PolygonCount(); c++) b.push(JSM.CalculatePolygonPlanarTextureCoords(a, c));
  return b
};
JSM.CalculateBodyCubicTextureCoords = function (a) {
  var b = [],
    c = JSM.CalculateBodyPolygonNormals(a),
    d, e;
  for (d = 0; d < a.PolygonCount(); d++) e = c[d], b.push(JSM.CalculatePolygonCubicTextureCoords(a, d, e));
  return b
};
JSM.CalculateBodyCylindricalTextureCoords = function (a) {
  var b = [],
    c = JSM.CalculateBodyPolygonNormals(a),
    d, e;
  for (d = 0; d < a.PolygonCount(); d++) e = c[d], b.push(JSM.CalculatePolygonCylindricalTextureCoords(a, d, e));
  return b
};
...
JSM.CutBodyByPlane = function (a, b) {
  function c(a, b, c) {
    ...
    var f = void 0 !== c && null !== c,
      ...
      l = !1,
      m, n, p;
    for (m = 0; m < g; m++) p = a[m], n = b.CoordPosition(p), k.push(n !== JSM.CoordPlanePosition.CoordAtBackOfPlane), 0 < m && k[m - 1] !== k[m] && (l = !0);
    if (!l) {
      if (!1 === k[0]) return h;
      for (m = 0; m < g; m++) p = a[m],
        h.push(new JSM.Coord(p.x, p.y, p.z)), f && c.push(m);
      return h
    }
    l = [];
    n = [];
    var q, s;
    for (m = 0; m < g; m++) q = m - 1, s = m, 0 === m && (q = g - 1), p = a[s], k[s] ? (k[q] || e(q, s, l, n), d(s, p, l, n)) : k[q] && e(q, s, l, n);
    for (m = 0; m < l.length; m++) g = l[m], k = h[h.length - 1], 0 === m || !k.IsEqual(g) ? (h.push(new JSM.Coord(g.x, g.y, g.z)), f && (g = n[m], c.push(g))) : f && (g = n[m], k = n[m - 1], -1 !== g ? c[c.length - 1] = g : -1 !== k && (c[c.length - 1] = k));
    return h
  }
  ...
  function d(a, b, c) {
    for (var d = -1; c < a.VertexCount(); c++)
      if (b.IsEqual(a.GetVertexPosition(c))) {
        d = c;
        break
      } - 1 === d && (d = a.AddVertex(new JSM.BodyVertex(new JSM.Coord(b.x,
      b.y, b.z))));
    return d
  }
  var e = new JSM.Body,
  ...
  for (l = 0; l < a.PolygonCount(); l++) {
    n = a.GetPolygon(l);
    q = [];
    for (m = 0; m < n.VertexIndexCount(); m++) p = a.GetVertexPosition(n.GetVertexIndex(m)), q.push(new JSM.Coord(p.x, p.y, p.z));
    p = [];
    q = c(q, b, p);
    for (m = 0; m < p.length; m++) - 1 !== p[m] && (h[n.GetVertexIndex(p[m])] = !0);
    f.push(q);
    g.push(p)
  }
  var r;
  for (l = 0; l < a.VertexCount(); l++) h[l] && (r = a.GetVertexPosition(l), k[l] = e.AddVertex(new JSM.BodyVertex(new JSM.Coord(r.x, r.y, r.z))));
  var h = e.VertexCount(),
    s;
  for (l =
    0; l < a.PolygonCount(); l++)
    if (n = a.GetPolygon(l), q = f[l], p = g[l], 0 !== p.length) {
      s = [];
      for (m = 0; m < p.length; m++) - 1 !== p[m] ? s.push(k[n.GetVertexIndex(p[m])]) : (r = q[m], s.push(d(e, r, h)));
...
JSM.GenerateCuboid = function (a, b, c) {
  ...
  d.AddVertex(new JSM.BodyVertex(new JSM.Coord(a, b, -c)));
  d.AddVertex(new JSM.BodyVertex(new JSM.Coord(a, b, c)));
  d.AddVertex(new JSM.BodyVertex(new JSM.Coord(-a,
    b, c)));
...
JSM.GenerateCuboidSides = function (a, b, c, d) {
  ...
  e.AddVertex(new JSM.BodyVertex(new JSM.Coord(a, b, -c)));
  e.AddVertex(new JSM.BodyVertex(new JSM.Coord(a, b, c)));
  e.AddVertex(new JSM.BodyVertex(new JSM.Coord(-a,
    b, c)));
...
JSM.GenerateSegmentedRectangle = function (a, b, c, d) {
  ...
  (function () {
    var a, b, n;
    for (a = 0; a <= d; a++)
      for (b = 0; b <= c; b++) n = new JSM.Coord(b * h - f, a * k - g, 0), e.AddVertex(new JSM.BodyVertex(n))
  })();
  (function () {
    var a, b, f, g, h, k;
    for (b = 0; b < d; b++)
      for (a = 0; a < c; a++) f = b * (c + 1) + a, g = f + 1, h = f + c + 1, k = h + 1, e.AddPolygon(new JSM.BodyPolygon([f, g, k, h]))
  })();
  return e
};
JSM.GenerateSegmentedCuboid = function (a, b, c, d) {
  ...
  function f(a) {
    var b = [],
      c = e(a);
    if (0 === a || a === d) {
      for (a = 0; a <= d; a++) b.push(c + a);
      for (a = 1; a <= d; a++) b.push(c + (a + 1) * d + a);
      for (a = d - 1; 0 <= a; a--) b.push(c + (d + 1) * d + a);
      for (a = d - 1; 0 < a; a--) b.push(c + a * (d + 1))
    } else if (0 < a && a < d) {
      for (a = 0; a <= d; a++) b.push(c + a);
      for (a = 1; a < d; a++) b.push(c + d + 2 * a);
      for (a = d; 0 <= a; a--) b.push(c + 3 * d + a - 1);
      for (a = d - 1; 0 < a; a--) b.push(c + d + 2 * a - 1)
    }
    return b
  }
  ...
  function g(a) {
    ...
    if (0 === a || a ===
      d)
      for (a = 0; a <= d; a++)
        for (b = 0; b <= d; b++) c = new JSM.Coord(b * q - l, a * p - m, e - n), k.AddVertex(new JSM.BodyVertex(c));
    else if (0 < a && a < d)
      for (a = 0; a <= d; a++)
        for (b = 0; b <= d; b++)
          if (0 === a || a === d || 0 === b || b === d) c = new JSM.Coord(b * q - l, a * p - m, e - n), k.AddVertex(new JSM.BodyVertex(c))
  }
  ...
  function h(a) {
    ...
    if (0 === a || a === d) {
      var m = e(a);
      for (b = 0; b < d; b++)
        for (c = 0; c < d; c++) f = m + b * (d + 1) + c, g = f + 1, h = f + d + 1, l = h + 1, 0 === a ? k.AddPolygon(new JSM.BodyPolygon([f, h, l, g])) : k.AddPolygon(new JSM.BodyPolygon([f, g, l, h]))
    }
    if (0 < a && a <= d) {
      c = s[a - 1];
      a = s[a];
      for (b = 0; b < 4 * d; b++) f = c[b], h = a[b], b < 4 * d - 1 ? (g = c[b + 1], l = a[b + 1]) : (g = c[0], l = a[0]), k.AddPolygon(new JSM.BodyPolygon([f, g, l, h]))
    }
  }
  var k = new JSM.Body,
    l = a / 2,
  ...
  for (a = 0; a <= d; a++) g(a);
  var s = [];
  for (a = 0; a <= d; a++) s.push(f(a));
  for (a = 0; a <= d; a++) h(a);
  return k
};
JSM.GenerateCircle = function (a, b) {
  var c = new JSM.Body,
    d = JSM.GenerateCirclePoints(a, b),
    e;
  for (e = 0; e < d.length; e++) c.AddVertex(new JSM.BodyVertex(d[e]));
  d = new JSM.BodyPolygon([]);
  for (e = 0; e < b; e++) d.AddVertexIndex(e);
  c.AddPolygon(d);
...
JSM.GenerateSphere = function (a, b, c) {
  var d = new JSM.Body,
    e = 2 * b,
    f = d.AddVertex(new JSM.BodyVertex(JSM.SphericalToCartesian(a, 0, 0))),
    g = Math.PI / b,
    h = g,
    k, l, m;
  for (k = 1; k < b; k++) {
    for (l = m = 0; l < e; l++) d.AddVertex(new JSM.BodyVertex(JSM.SphericalToCartesian(a, h, m))), m += g;
    h += g
  }
  ...
  for (k = 1; k <= b; k++)
    if (1 === k) {
      g = 1;
      for (l = 0; l < e; l++) h = g + l, m = h + 1, l === e - 1 && (m = g), h = new JSM.BodyPolygon([h, m, f]), c && h.SetCurveGroup(0), d.AddPolygon(h)
    } else if (k < b) {
    g = (k - 1) * e +
      1;
    for (l = 0; l < e; l++) h = g + l, m = h + 1, n = h - e, q = n + 1, l === e - 1 && (m = g, q = g - e), h = new JSM.BodyPolygon([h, m, q, n]), c && h.SetCurveGroup(0), d.AddPolygon(h)
  } else if (k === b) {
    g = (k - 2) * e + 1;
    for (l = 0; l < e; l++) h = g + l, m = h + 1, l === e - 1 && (m = g), h = new JSM.BodyPolygon([h, a, m]), c && h.SetCurveGroup(0), d.AddPolygon(h)
  }
...
JSM.GenerateTriangulatedSphere = function (a, b, c) {
  ...
  for (var e = d.GetVertexPosition(0).Length(), f = a / e, g, h, e = 0; e < d.VertexCount(); e++) h = d.GetVertex(e), h.position.MultiplyScalar(f);
  for (var k, l, m, n, f = 0; f < b; f++) {
    g = d;
    d = new JSM.Body;
    h = new JSM.AdjacencyInfo(g);
    for (e = 0; e < h.verts.length; e++) k = g.GetVertexPosition(e), JSM.AddVertexToBody(d, k.x, k.y, k.z);
    k = [];
    for (e = 0; e < h.edges.length; e++) l = h.edges[e], l = JSM.MidCoord(g.GetVertexPosition(l.vert1), g.GetVertexPosition(l.vert2)), k.push(d.AddVertex(new JSM.BodyVertex(l.SetLength(a))));
    for (e = 0; e < h.pgons.length; e++) {
      l = h.pgons[e];
      m = [];
      for (g = 0; g < l.pedges.length; g++) n = l.pedges[g], m.push(h.GetPolyEdgeStartVertex(n)), m.push(k[n.index]);
  ...
  if (c)
    for (e = 0; e < d.PolygonCount(); e++) d.GetPolygon(e).SetCurveGroup(0);
  d.SetCubicTextureProjection(new JSM.Coord(0, 0, 0), new JSM.Coord(1, 0, 0), new JSM.Coord(0, 1, 0), new JSM.Coord(0, 0, 1));
  return d
};
JSM.GenerateCylinder = function (a, b, c, d, e) {
  var f = new JSM.Body,
    ...
    h = 2 * Math.PI / c,
    k;
  for (k = 0; k < c; k++) f.AddVertex(new JSM.BodyVertex(JSM.CylindricalToCartesian(a, b / 2, g))), f.AddVertex(new JSM.BodyVertex(JSM.CylindricalToCartesian(a, -b / 2, g))), g -= h;
  for (k = 0; k < c; k++) g = 2 * k, h = g + 2, k === c - 1 && (h = 0), g = new JSM.BodyPolygon([g, h, h + 1, g + 1]), e && g.SetCurveGroup(0), f.AddPolygon(g);
  if (d) {
    d = new JSM.BodyPolygon([]);
    e = new JSM.BodyPolygon([]);
    for (k = 0; k < c; k++) d.AddVertexIndex(2 * (c - k - 1)), e.AddVertexIndex(2 * k + 1);
    f.AddPolygon(d);
    f.AddPolygon(e)
  }
...
JSM.GeneratePie = function (a, b, c, d, e, f) {
  ...
  g.AddVertex(new JSM.BodyVertex(JSM.CylindricalToCartesian(0, -b / 2, 0)));
  for (c = 0; c < d; c++) g.AddVertex(new JSM.BodyVertex(JSM.CylindricalToCartesian(a, b / 2, h))), g.AddVertex(new JSM.BodyVertex(JSM.CylindricalToCartesian(a, -b / 2, h))), h -= k;
  for (c = 0; c <= d; c++) h = 2 * c, k = h + 2, c === d && (k = 0), h = new JSM.BodyPolygon([h, k, k + 1, h + 1]), f && (0 < c && c < d) && h.SetCurveGroup(0), g.AddPolygon(h);
  if (e) {
    e =
      new JSM.BodyPolygon([]);
    f = new JSM.BodyPolygon([]);
    for (c = 0; c <= d; c++) e.AddVertexIndex(2 * (d - c)), f.AddVertexIndex(2 * c + 1);
    g.AddPolygon(e);
    g.AddPolygon(f)
  }
...
JSM.GenerateCone = function (a, b, c, d, e, f) {
  ...
  var n;
  for (n = 0; n < d; n++) h || g.AddVertex(new JSM.BodyVertex(JSM.CylindricalToCartesian(a, c / 2, l))), k || g.AddVertex(new JSM.BodyVertex(JSM.CylindricalToCartesian(b, -c / 2, l))), l -= m;
  k && g.AddVertex(new JSM.BodyVertex(JSM.CylindricalToCartesian(0, -c / 2, 0)));
  for (n = 0; n < d; n++) h ? (l = n + 1, m = l + 1, n === d - 1 && (m = 1), l = new JSM.BodyPolygon([0,
    m, l
  ])) : k ? (l = n, m = l + 1, n === d - 1 && (m = 0), l = new JSM.BodyPolygon([l, m, d])) : (l = 2 * n, m = l + 2, n === d - 1 && (m = 0), l = new JSM.BodyPolygon([l, m, m + 1, l + 1])), f && l.SetCurveGroup(0), g.AddPolygon(l);
  if (e)
    if (h) {
      f = new JSM.BodyPolygon([]);
      for (n = 0; n < d; n++) f.AddVertexIndex(n + 1);
      g.AddPolygon(f)
    } else if (k) {
    e = new JSM.BodyPolygon([]);
    for (n = 0; n < d; n++) e.AddVertexIndex(d - n - 1);
    g.AddPolygon(e)
  } else {
    e = new JSM.BodyPolygon([]);
    f = new JSM.BodyPolygon([]);
    for (n = 0; n < d; n++) e.AddVertexIndex(2 * (d - n - 1)), f.AddVertexIndex(2 * n + 1);
    g.AddPolygon(e);
    g.AddPolygon(f)
  }
  g.SetCylindricalTextureProjection(new JSM.Coord(0,
    0, -(c / 2)), (a + b) / 2, new JSM.Coord(1, 0, 0), new JSM.Coord(0, 0, 1));
  return g
};
JSM.GeneratePrismGeometry = function (a, b, c) {
  var d = new JSM.Body,
    e = a.length,
    f;
  for (f = 0; f < e; f++) d.AddVertex(new JSM.BodyVertex(a[f].Clone())), d.AddVertex(new JSM.BodyVertex(b[f].Clone()));
  for (f = 0; f < e; f++) a = 2 * f, b = a + 2, f === e - 1 && (b = 0), a = new JSM.BodyPolygon([a, b, b + 1, a + 1]), d.AddPolygon(a);
  if (c) {
    c = new JSM.BodyPolygon([]);
    a = new JSM.BodyPolygon([]);
    for (f = 0; f < e; f++) c.AddVertexIndex(2 * f + 1), a.AddVertexIndex(2 * (e - f - 1));
    d.AddPolygon(c);
    d.AddPolygon(a)
  }
  return d
...
JSM.GeneratePrismFromPolygon = function (a, b, c, d) {
  var e = [],
    f = [],
    g, h, k = a.VertexCount();
  for (g = 0; g < k; g++) h = a.GetVertex(g), e.push(new JSM.Coord(h.x, h.y, 0)), f.push(new JSM.Coord(h.x, h.y, b));
  b = JSM.GeneratePrismGeometry(e, f, c);
  if (void 0 !== d && null !== d) {
    a = JSM.CalculatePolygonCurveGroups(a, d);
    for (g = 0; g < k; g++) d = b.GetPolygon(g), d.SetCurveGroup(a[g])
  }
  g = e[0].Clone();
  e = e[1].Clone();
  ...
  b.SetCubicTextureProjection(g, a,
    k, e);
  return b
};
JSM.GeneratePrism = function (a, b, c, d, e) {
  ...
  var g = [],
    h = [],
    k;
  for (k = 0; k < a; k++) g.push(f.GetVertex(k).Clone()), h.push(f.GetVertex(k).Clone().Offset(b, c));
  c = JSM.GeneratePrismGeometry(g, h, d);
  if (void 0 !== e && null !== e) {
    e = JSM.CalculatePolygonCurveGroups(f, e);
    for (k = 0; k < a; k++) d = c.GetPolygon(k), d.SetCurveGroup(e[k])
  }
...
JSM.GeneratePrismWithHole = function (a, b, c, d, e) {
  function f(a, b) {
    ...
    if (null !== d && (d = JSM.TriangulatePolygon2D(d), null !== d)) {
      var e, f, h, k, u, t;
      for (e = 0; e < d.length; e++) {
        h = d[e];
        u = new JSM.BodyPolygon([]);
        t = new JSM.BodyPolygon([]);
        for (f = 0; 3 > f; f++) k = c[h[f]], u.AddVertexIndex(2 * b[k[0]] + 2 * k[1] + 1), k = c[h[2 - f]], t.AddVertexIndex(2 * b[k[0]] + 2 * k[1]);
        g.AddPolygon(u);
        g.AddPolygon(t)
      }
    }
  ...
  (function (a, b, c, d) {
    ...
    for (e = 0; e < a.ContourCount(); e++) {
      g = a.GetContour(e);
      for (f = 0; f < g.VertexCount(); f++) h = g.GetVertex(f).Clone(), k = g.GetVertex(f).Clone().Offset(b, c), d.AddVertex(new JSM.BodyVertex(h)), d.AddVertex(new JSM.BodyVertex(k))
    }
  })(k, b, c, g);
  (function (a, b, c, d) {
    var e = 0,
    ...
    for (f = 0; f < a.ContourCount(); f++) {
      ...
      h = g.VertexCount();
      b.push(e);
      for (g = 0; g < h; g++) k = 2 * e + 2 * g, t = k + 2, g == h - 1 && (t = 2 * e), k = new JSM.BodyPolygon([k,
        t, t + 1, k + 1
      ]), null !== y && k.SetCurveGroup(y[g]), d.AddPolygon(k);
      e += h
    }
  })(k, h, e, g);
  d && f(k, h);
...
JSM.GeneratePrismsFromPath2D = function (a, b, c, d) {
  function e(a) {
    ...
    for (c = 0; c < a.ContourCount(); c++) {
      e = a.GetContour(c);
      for (d = 0; d < e.VertexCount(); d++) f = e.GetVertex(d), b.push(new JSM.Coord(f.x, f.y, 0));
  ...
  var f = [];
  a = a.GetPolygons();
  var g = new JSM.Vector(0, 0, 1),
    h, k;
  for (h = 0; h < a.length; h++) k = a[h], 1 === k.ContourCount() ? f.push(JSM.GeneratePrism(e(k), g, b, c, d)) : 1 < k.ContourCount() && f.push(JSM.GeneratePrismWithHole(e(k), g, b, c, d));
  return f
};
JSM.GeneratePrismShell = function (a, b, c, d, e) {
  var f = new JSM.Body,
    g = a.length,
    h;
  for (h = 0; h < g; h++) f.AddVertex(new JSM.BodyVertex(a[h]));
  h = new JSM.Polygon;
  h.vertices = a;
  d = JSM.OffsetPolygonContour(h, d).vertices;
  for (h = 0; h < g; h++) f.AddVertex(new JSM.BodyVertex(d[h]));
  var k;
  for (h = 0; h < g; h++) k = a[h].Clone().Offset(b, c), f.AddVertex(new JSM.BodyVertex(k));
  for (h = 0; h < g; h++) k = d[h].Clone().Offset(b, c), f.AddVertex(new JSM.BodyVertex(k));
  var l;
  for (h = 0; h < g; h++) c = h, d = c + 1, k = c + 2 * g, l = k + 1, h === g - 1 && (d = 0, l = 2 * g), f.AddPolygon(new JSM.BodyPolygon([c,
    d, l, k
  ])), f.AddPolygon(new JSM.BodyPolygon([c + g, k + g, l + g, d + g]));
  if (e)
    for (h = 0; h < g; h++) c = h, d = c + 1, k = h + g, l = k + 1, h === g - 1 && (d = 0, l = g), f.AddPolygon(new JSM.BodyPolygon([c, k, l, d])), f.AddPolygon(new JSM.BodyPolygon([c + 2 * g, d + 2 * g, l + 2 * g, k + 2 * g]));
...
JSM.GenerateCylinderShell = function (a, b, c, d, e, f) {
  for (var g = new JSM.Vector(0, 0, 1), h = -b / 2, k = [], l = 2 * Math.PI / d, m, n = 0, n = 0; n < d; n++) m = n * l, m = JSM.PolarToCartesian(a, m), k.push(new JSM.Coord(m.x, m.y, h));
  a = JSM.GeneratePrismShell(k, g, b, c, e);
  if (f)
    for (f = 0; f < d; f++) a.GetPolygon(2 * f).SetCurveGroup(0), a.GetPolygon(2 * f + 1).SetCurveGroup(0);
  return a
};
JSM.GenerateLineShell = function (a, b, c, d, e, f) {
  var g = new JSM.Body,
    ...
    k = [],
    l, m, n, q, p, r;
  for (l = 0; l < h; l++) 0 === l || l === h - 1 ? p = Math.PI / 2 : (m = l - 1, n = l, q = l + 1, r = JSM.CoordSub(a[q], a[n]), p = JSM.CoordSub(a[m], a[n]), p = r.AngleTo(p) / 2, JSM.CoordOrientation(a[m], a[n], a[q], b) == JSM.Orientation.Clockwise && (p = Math.PI - p)), k.push(p);
  r = new JSM.Vector(0, 0, 1);
  m = [];
  var s, v;
  for (l = 0; l < h; l++) n = l, l === h - 1 ? v = JSM.CoordSub(a[n - 1], a[n]) : (q = (l + 1) % h, v = JSM.CoordSub(a[n], a[q])), p = k[n], q = d / Math.sin(p), s = a[n].Clone(), s.Offset(v, q), s.Rotate(r,
    -(Math.PI - p), a[n]), m.push(s);
  for (l = 0; l < h; l++) g.AddVertex(new JSM.BodyVertex(a[l]));
  for (l = 0; l < h; l++) g.AddVertex(new JSM.BodyVertex(m[l]));
  for (l = 0; l < h; l++) n = a[l].Clone().Offset(b, c), g.AddVertex(new JSM.BodyVertex(n));
  for (l = 0; l < h; l++) n = m[l].Clone().Offset(b, c), g.AddVertex(new JSM.BodyVertex(n));
  for (l = 0; l < h - 1; l++) n = l, q = n + 1, c = n + 2 * h, d = c + 1, g.AddPolygon(new JSM.BodyPolygon([n, q, d, c])), g.AddPolygon(new JSM.BodyPolygon([n + h, c + h, d + h, q + h]));
  e && (n = 0, g.AddPolygon(new JSM.BodyPolygon([n, n + 2 * h, n + 3 * h, n + h])), n = h - 1,
    g.AddPolygon(new JSM.BodyPolygon([n, n + h, n + 3 * h, n + 2 * h])));
  if (f)
    for (l = 0; l < h - 1; l++) n = l, q = n + 1, c = l + h, d = c + 1, g.AddPolygon(new JSM.BodyPolygon([n, c, d, q])), g.AddPolygon(new JSM.BodyPolygon([n + 2 * h, q + 2 * h, d + 2 * h, c + 2 * h]));
  e = JSM.CoordSub(a[1], a[0]).Normalize();
  a = new JSM.Coord(a[0].x, a[0].y, a[0].z);
  b = b.Clone().Normalize();
  e = JSM.VectorCross(b, e);
...
JSM.GenerateTorus = function (a, b, c, d, e) {
  var f = new JSM.Body,
    ...
    k = [],
    l, m;
  for (l = 0; l < d; l++) m = JSM.PolarToCartesian(b, g), m = new JSM.Coord(m.x + a, 0, m.y), k.push(m), g += h;
  b = new JSM.Coord(0, 0, 1);
  g = new JSM.Coord(0, 0, 0);
  h = 2 * Math.PI / c;
  for (l = 0; l < c; l++)
    for (a = 0; a < d; a++) m = k[a].Clone().Rotate(b, l * h, g), f.AddVertex(new JSM.BodyVertex(m));
  for (l = 0; l < c; l++) {
    new JSM.BodyPolygon([]);
    for (a = 0; a < d; a++) h = l * d + a, b = h + d, k = h + 1, g = b + 1, a === d - 1 && (k = l * d, g = (l + 1) * d), l === c - 1 && (b = a, g = a + 1, a === d - 1 && (g = 0)), h = new JSM.BodyPolygon([h,
      b, g, k
    ]), e && h.SetCurveGroup(0), f.AddPolygon(h)
  }
...
JSM.GeneratePolyTorus = function (a, b, c, d) {
  var e = new JSM.Body,
    ...
    h = [],
    k;
  for (k = 0; k < f; k++) g = a[k], g = new JSM.Coord(g.x + b, 0, g.y), h.push(g);
  b = new JSM.Coord(0, 0, 1);
  var l = new JSM.Coord(0, 0, 0),
    g = 2 * Math.PI / c,
    m;
  for (k = 0; k < c; k++)
    for (a = 0; a < f; a++) m = h[a].Clone().Rotate(b, k * g, l), e.AddVertex(new JSM.BodyVertex(m));
  for (k = 0; k < c; k++) {
    new JSM.BodyPolygon([]);
    for (a = 0; a < f; a++) h = k * f + a, b = h + f, g = h + 1, l = b + 1, a === f - 1 && (g = k * f, l = (k + 1) * f), k === c - 1 && (b = a, l = a + 1, a === f - 1 && (l = 0)), h = new JSM.BodyPolygon([h, b, l, g]), d && h.SetCurveGroup(a),
      e.AddPolygon(h)
  }
...
JSM.GenerateRuledFromSectors = function (a, b, c, d, e) {
  ...
  for (d = 0; d < c.length; d++) f.AddVertex(new JSM.BodyVertex(c[d]));
  for (d = 0; d < b.length; d++) a = b[d], a = new JSM.BodyPolygon(a), e && a.SetCurveGroup(0), f.AddPolygon(a);
  f.SetCubicTextureProjection(new JSM.Coord(0, 0, 0), new JSM.Coord(1, 0, 0), new JSM.Coord(0, 1, 0), new JSM.Coord(0, 0, 1));
  return f
};
...
JSM.GenerateRuledFromSectorsWithHeight = function (a, b, c, d, e, f) {
  ...
  for (a = 0; a < h.length; a++) g.AddVertex(new JSM.BodyVertex(h[a]));
  var l;
  for (a = 0; a < k.length; a++) l = k[a], l = new JSM.BodyPolygon(l), e && l.SetCurveGroup(0), g.AddPolygon(l);
  b = g.VertexCount();
  for (a = 0; a < h.length; a++) l = h[a], l = new JSM.Coord(l.x, l.y, l.z), l.z -= f, g.AddVertex(new JSM.BodyVertex(l));
  for (a = 0; a < k.length; a++) {
    l = k[a];
    h = [];
    for (f = l.length - 1; 0 <= f; f--) h.push(l[f] + b);
    l = new JSM.BodyPolygon(h);
    e && l.SetCurveGroup(0);
    g.AddPolygon(l)
  }
  for (a = 0; a < d; a++) e = a + b, f = e + 1, k = e - b, h = k + 1, l = new JSM.BodyPolygon([e, f, h, k]), g.AddPolygon(l);
  for (a = 0; a < d; a++) e = a + c * (d + 1) + b, f = e + 1, k = e - b, h = k + 1, l = new JSM.BodyPolygon([e, k, h, f]), g.AddPolygon(l);
  for (a = 0; a < c; a++) e = a * (d + 1) + b, f = e + d + 1, k = e - b, h = k + d + 1, l = new JSM.BodyPolygon([e, k, h, f]), g.AddPolygon(l);
  for (a = 0; a < c; a++) e = (a + 1) * d + a + b, f = e + d + 1, k = e - b, h = k + d + 1, l = new JSM.BodyPolygon([e, f, h, k]), g.AddPolygon(l);
  g.SetCubicTextureProjection(new JSM.Coord(0,
    0, 0), new JSM.Coord(1, 0, 0), new JSM.Coord(0, 1, 0), new JSM.Coord(0, 0, 1));
  return g
};
JSM.GenerateRuledFromCoords = function (a, b, c, d) {
  ...
  for (a = 0; a < f.length; a++) e.AddVertex(new JSM.BodyVertex(f[a]));
  for (a = 0; a < g.length; a++) f = g[a], f = new JSM.BodyPolygon(f), d && f.SetCurveGroup(0), e.AddPolygon(f);
  e.SetCubicTextureProjection(new JSM.Coord(0, 0, 0), new JSM.Coord(1, 0, 0), new JSM.Coord(0, 1, 0), new JSM.Coord(0, 0, 1));
  return e
};
JSM.GenerateRevolved = function (a, b, c, d, e, f) {
  ...
  var m, n, q;
  for (m = 0; m < k; m++)
    for (n = 0; n <= d; n++) h && n === d || (q = a[m].Clone().Rotate(c, n * l, b.beg), g.AddVertex(new JSM.BodyVertex(q)));
  l = 0;
  "CurveSegments" == f ? l = 1 : "CurveAll" == f && (l = 2);
  var p, r;
  for (m = 0; m < k - 1; m++)
    for (n = 0; n < d; n++) f = m * (d + 1) + n, q = f + d + 1, p = f + 1, r = q + 1, h && (f = m * d + n, q = f + d, p = f + 1, r = q + 1, n === d - 1 && (p = m * d, r = (m + 1) * d)), f = new JSM.BodyPolygon([f, p, r, q]), 1 == l ? f.SetCurveGroup(m) : 2 == l &&
      f.SetCurveGroup(0), g.AddPolygon(f);
  if (h && e) {
    e = new JSM.BodyPolygon([]);
    h = new JSM.BodyPolygon([]);
    for (m = 0; m < d; m++) e.AddVertexIndex(d * (k - 1) + m), h.AddVertexIndex(d - m - 1);
    g.AddPolygon(e);
    g.AddPolygon(h)
  }
  d = c.Clone().Normalize();
  h = new JSM.Line(b.beg, d);
  for (m = e = 0; m < k; m++) n = h.ProjectCoord(a[m]), e += n.DistanceTo(a[m]);
  e /= k;
...
JSM.GenerateTube = function (a, b) {
  var c = new JSM.Body,
    ...
    f, g;
  for (g = 0; g < e; g++)
    for (f = 0; f < d; f++) c.AddVertex(new JSM.BodyVertex(a[f][g]));
  var h, k;
  for (g = 0; g < d - 1; g++)
    for (f = 0; f < e; f++) h = g + d * f, k = h + d, f === e - 1 && (k = g), c.AddPolygon(new JSM.BodyPolygon([h, k, k + 1, h + 1]));
  if (b) {
    g = new JSM.BodyPolygon([]);
    h = new JSM.BodyPolygon([]);
    for (f = 0; f < e; f++) g.AddVertexIndex(d * f + d - 1);
    for (f = e - 1; 0 <= f; f--) h.AddVertexIndex(d * f);
    c.AddPolygon(g);
    c.AddPolygon(h)
  }
  c.SetCubicTextureProjection(new JSM.Coord(0, 0, 0), new JSM.Coord(1,
    0, 0), new JSM.Coord(0, 1, 0), new JSM.Coord(0, 0, 1));
  return c
};
JSM.GenerateFunctionSurface = function (a, b, c, d, e) {
  ...
  for (e = 0; e < d.VertexCount(); e++) f = d.GetVertexPosition(e), f.z = a(f.x, f.y);
  d.SetCubicTextureProjection(new JSM.Coord(0, 0, 0), new JSM.Coord(1, 0, 0), new JSM.Coord(0, 1, 0), new JSM.Coord(0, 0, 1));
  return d
};
JSM.GenerateFunctionSurfaceSolid = function (a, b, c, d, e, f) {
  ...
  g = (d + 1) * (d + 1);
  for (d = 0; d < g; d++) f = e.GetVertexPosition(d), f.z = a(f.x, f.y);
  e.SetCubicTextureProjection(new JSM.Coord(0, 0, 0), new JSM.Coord(1, 0, 0), new JSM.Coord(0, 1, 0), new JSM.Coord(0, 0, 1));
  return e
};
...
JSM.ExplodeBody = function (a, b, c) {
  function d(a, b, c, d) {
    var k;
    for (k = 0; k < a.Count(); k++) b.push([]);
    a = d.itemCount();
    var l;
    for (k = 0; k < a; k++) l = d.getMaterial(k), -1 !== l ? b[l].push(k) : c.push(k)
  }
  if (void 0 === c || null === c) return !1;
  if (void 0 === b || null === b) b = new JSM.MaterialSet;
  (function (a, b, c) {
    function h(c, d, g) {
      if (0 !== c.length) {
        d = b.GetMaterial(d);
        if (void 0 !== g.onPointGeometryStart && null !== g.onPointGeometryStart) g.onPointGeometryStart(d);
        if (void 0 !== g.onPoint && null !== g.onPoint) {
          var h, k;
          for (h = 0; h < c.length; h++) k = a.GetPoint(c[h]),
            k = a.GetVertexPosition(k.GetVertexIndex()), g.onPoint(k)
        }
        if (void 0 !== g.onPointGeometryEnd && null !== g.onPointGeometryEnd) g.onPointGeometryEnd(d)
      }
    }
    if (0 !== a.PointCount()) {
      var k = [],
      ...
      var m;
      for (m = 0; m < k.length; m++) h(k[m], m, c);
      h(l, -1, c)
    }
  })(a, b, c);
  (function (a, b, c) {
    function h(c, d, g) {
      if (0 !== c.length) {
        d = b.GetMaterial(d);
        if (void 0 !== g.onLineGeometryStart && null !== g.onLineGeometryStart) g.onLineGeometryStart(d);
        if (void 0 !== g.onLine && null !== g.onLine) {
          var h, k, l;
          for (h = 0; h < c.length; h++) k = a.GetLine(c[h]), l = a.GetVertexPosition(k.GetBegVertexIndex()), k = a.GetVertexPosition(k.GetEndVertexIndex()), g.onLine(l, k)
        }
        if (void 0 !== g.onLineGeometryEnd && null !== g.onLineGeometryEnd) g.onLineGeometryEnd(d)
      }
    }
    if (0 !== a.LineCount()) {
      var k = [],
  ...
  (function (a,
    b, c) {
    function h(a, b) {
      var c = JSM.CalculateBodyVertexNormals(a),
        d, e;
      e = !1;
      if (void 0 !== b && null !== b)
        for (d = 0; d < b.Count(); d++)
      ...
      if (e) {
        ...
        for (d = 0; d < f.length; d++)
          if (e = a.GetPolygon(d), e.HasMaterialIndex()) {
            g = b.GetMaterial(e.GetMaterialIndex());
            for (e = 0; e < f[d].length; e++) f[d][e].x /= g.textureWidth, f[d][e].y /= -g.textureHeight
          }
      }
      return {
        vertexNormals: c,
    ...
    function k(c, d, g, h) {
      if (0 !== c.length) {
        d = b.GetMaterial(d);
        if (void 0 !== h.onGeometryStart && null !== h.onGeometryStart) h.onGeometryStart(d);
        var k;
        for (k = 0; k < c.length; k++) {
          ...
          if (3 > w) JSM.Message("Invalid polygon found.");
          else {
            var x = void 0,
              A = void 0,
              E = void 0,
            ...
            if (3 == w || x)
              for (F = 0; F < w - 2; F++) {
                if (x = a.GetVertexPosition(q.GetVertexIndex(0)), A = a.GetVertexPosition(q.GetVertexIndex((F +
                    1) % w)), E = a.GetVertexPosition(q.GetVertexIndex((F + 2) % w)), G = m.vertexNormals[l][0], H = m.vertexNormals[l][(F + 1) % w], z = m.vertexNormals[l][(F + 2) % w], L = K = D = null, null !== m.textureCoords && (D = m.textureCoords[l][0], K = m.textureCoords[l][(F + 1) % w], L = m.textureCoords[l][(F + 2) % w]), void 0 !== n.onTriangle && null !== n.onTriangle) n.onTriangle(x, A, E, G, H, z, D, K, L)
              } else {
                x = new JSM.Polygon;
                A = void 0;
                for (F = 0; F < w; F++) A = a.GetVertexPosition(q.vertices[F]), x.AddVertex(A.x, A.y, A.z);
                F = JSM.CalculateBodyPolygonNormal(a, l);
                w = JSM.TriangulatePolygon(x,
                  F);
                if (null !== w)
                  for (var J = void 0, F = 0; F < w.length; F++) {
                    if (J = w[F], x = a.GetVertexPosition(q.GetVertexIndex(J[0])), A = a.GetVertexPosition(q.GetVertexIndex(J[1])), E = a.GetVertexPosition(q.GetVertexIndex(J[2])), G = m.vertexNormals[l][J[0]], H = m.vertexNormals[l][J[1]], z = m.vertexNormals[l][J[2]], L = K = D = null, null !== m.textureCoords && (D = m.textureCoords[l][J[0]], K = m.textureCoords[l][J[1]], L = m.textureCoords[l][J[2]]), void 0 !== n.onTriangle && null !== n.onTriangle) n.onTriangle(x, A, E, G, H, z, D, K, L)
                  } else JSM.Message("Triangulation failed.")
              }
          }
        }
        if (void 0 !==
          h.onGeometryEnd && null !== h.onGeometryEnd) h.onGeometryEnd(d)
      }
    }
    if (0 !== a.PolygonCount()) {
      var l = [],
      ...
      var n = h(a, b),
        q;
      for (q = 0; q < l.length; q++) k(l[q], q, n, c);
      k(m, -1, n, c)
    }
  })(a, b, c);
  return !0
...
JSM.ExportBodyContentToStl = function (a, b, c) {
  ...
  function f(b) {
    ...
    if (!(3 > f)) {
      var g, n, q, p = null;
      if (3 === f) p = JSM.CalculateBodyPolygonNormal(a, b), g = a.GetVertex(d.GetVertexIndex(0)).position, n = a.GetVertex(d.GetVertexIndex(1)).position,
        q = a.GetVertex(d.GetVertexIndex(2)).position, e(p, g, n, q);
      else if (g = !0, void 0 !== c && c && (g = !1), p = JSM.CalculateBodyPolygonNormal(a, b), g) {
        g = new JSM.Polygon;
        for (b = 0; b < f; b++) n = a.GetVertex(d.vertices[b]), g.AddVertex(n.position.x, n.position.y, n.position.z);
        f = JSM.TriangulatePolygon(g, p);
        if (null !== f)
          for (b = 0; b < f.length; b++) q = f[b], g = a.GetVertex(d.GetVertexIndex(q[0])).position, n = a.GetVertex(d.GetVertexIndex(q[1])).position, q = a.GetVertex(d.GetVertexIndex(q[2])).position, e(p, g, n, q)
      } else
        for (b = 0; b < f - 2; b++) g = a.GetVertex(d.GetVertexIndex(0)).position,
          n = a.GetVertex(d.GetVertexIndex((b + 1) % f)).position, q = a.GetVertex(d.GetVertexIndex((b + 2) % f)).position, e(p, g, n, q)
    }
  }
  var g = "";
  for (b = 0; b < a.PolygonCount(); b++) f(b);
  return g
};
...
JSM.ExportModelToStl = function (a, b, c) {
  ...
  d = "" + ("solid " + b + "\n");
  var e, f;
  for (e = 0; e < a.BodyCount(); e++) f = a.GetBody(e), d += JSM.ExportBodyContentToStl(f, b + (e + 1).toString(), c);
  return d + ("endsolid " + b + "\n")
};
JSM.ExportBodyContentToObj = function (a, b, c) {
  ...
  var g = "",
    h;
  for (h = 0; h < a.VertexCount(); h++) d(h);
  for (h = 0; h < a.PolygonCount(); h++) e(h);
  for (h = 0; h < a.PolygonCount(); h++) f(h);
  return g
};
...
JSM.ExportModelToObj = function (a) {
  var b = "",
    ...
    d = 0,
    e, f;
  for (e = 0; e < a.BodyCount(); e++) f = a.GetBody(e), b += JSM.ExportBodyContentToObj(f, c, d), c += f.VertexCount(), d += f.PolygonCount();
  return b
};
JSM.ExportMaterialsToGdl = function (a) {
  ...
  if (d) {
    ...
    for (d = 0; d < a.Count(); d++) b(a.GetMaterial(d), d + 2)
  }
  return c
};
JSM.ExportBodyGeometryToGdl = function (a, b) {
  function c(a) {
    if (200 < a.length) {
      var b = 0,
        c, d;
      for (c = 0; c < a.length; c++) d = a[c], h += d, b++, 200 < b && "," == d && (h += "\n", b = 0)
    } else h += a
  }
  ...
  function f(b, c) {
    var e = b.edges[c],
      f = 0; - 1 != e.pgon1 && -1 != e.pgon2 && a.GetPolygon(e.pgon1).HasCurveGroup() && a.GetPolygon(e.pgon2).HasCurveGroup() && a.GetPolygon(e.pgon1).GetCurveGroup() == a.GetPolygon(e.pgon2).GetCurveGroup() && (f = 2);
    d("edge " + (e.vert1 + 1) + ", " + (e.vert2 + 1) + ", -1, -1, " + f + " ! " + (c + 1))
  }

  function g(e, f, g) {
    var h = -1;
    b && (h = a.GetPolygon(f).GetMaterialIndex() + 2, h != g && d('set material "material' + h + '"'));
    e = e.pgons[f];
    g = 0;
    ...
    g = "";
    var k, l;
    for (k = 0; k < e.pedges.length; k++) l = e.pedges[k], g = l.reverse ? g + -(l.index + 1) : g + (l.index + 1), k < e.pedges.length - 1 && (g += ", ");
    c(g);
    c(" ! " + (f + 1));
    d("");
    return h
  ...
  var h = "";
  d("base");
  var k = new JSM.AdjacencyInfo(a),
    l;
  for (l = 0; l <
    k.verts.length; l++) e(l);
  for (l = 0; l < k.edges.length; l++) f(k, l);
  var m = -1;
  for (l = 0; l < k.pgons.length; l++) m = g(k, l, m);
  d("body -1");
  return h
};
JSM.ExportBodyToGdl = function (a, b) {
  var c = "",
    d = !1;
  void 0 !== b && null !== b && (c += JSM.ExportMaterialsToGdl(b), d = !0);
...
JSM.ExportModelToGdl = function (a, b) {
  ...
  void 0 !== b && null !== b && (c += JSM.ExportMaterialsToGdl(b), d = !0);
  var e, f;
  for (e = 0; e < a.BodyCount(); e++) f = a.GetBody(e), c += JSM.ExportBodyGeometryToGdl(f, d);
  return c
};
...
JSM.TriangleBody.prototype.GetTriangleNormal = function (a, b) {
  var c = null,
    d = this.triangles[a];
  if (-1 == d.curve) c = this.GetNormal(d.n0);
  else var c = this.GetVertex(d.v0),
...
JSM.TriangleBody.prototype.GetBoundingBox = function () {
  var a = new JSM.Coord(JSM.Inf, JSM.Inf, JSM.Inf),
    b = new JSM.Coord(-JSM.Inf, -JSM.Inf, -JSM.Inf),
    c, d;
  for (c = 0; c < this.vertices.length; c++) d = this.vertices[c], a.x = JSM.Minimum(a.x, d.x), a.y = JSM.Minimum(a.y, d.y), a.z = JSM.Minimum(a.z, d.z), b.x = JSM.Maximum(b.x, d.x), b.y = JSM.Maximum(b.y, d.y), b.z = JSM.Maximum(b.z, d.z);
  return new JSM.Box(a, b)
};
...
JSM.TriangleBody.prototype.GetBoundingSphere = function () {
  var a = this.GetCenter(),
    b = 0,
    c, d;
  for (c = 0; c < this.vertices.length; c++) d = a.DistanceTo(this.vertices[c]), JSM.IsGreater(d, b) && (b = d);
  return new JSM.Sphere(a, b)
};
JSM.TriangleBody.prototype.Finalize = function (a) {
  function b(b, c, d, e) {
    function f(a, b, c, d, e) {
      ...
      b = e[b];
      var k, l;
      for (e = 0; e < b.length; e++) k = b[e], l = a.GetTriangle(k), c.curve == l.curve && (g = JSM.CoordAdd(g, d[k]), h += 1);
      g.MultiplyScalar(1 / h);
      g.Normalize();
      return a.AddNormal(g.x, g.y, g.z)
    }
    var g = b.triangles[c];
    if (void 0 === g.mat || 0 > g.mat) g.mat = a.GetDefaultMaterialIndex();
    if (void 0 === g.n0 || void 0 === g.n1 || void 0 === g.n2) void 0 === g.curve || 0 > g.curve ? (c = d[c], c = b.AddNormal(c.x,
      c.y, c.z), g.n0 = c, g.n1 = c, g.n2 = c, g.curve = -1) : (g.n0 = f(b, g.v0, c, d, e), g.n1 = f(b, g.v1, c, d, e), g.n2 = f(b, g.v2, c, d, e));
    if (void 0 === g.u0 || void 0 === g.u1 || void 0 === g.u2) g.u0 = b.AddDefaultUV(), g.u1 = b.AddDefaultUV(), g.u2 = b.AddDefaultUV()
  }
  var c = [],
    d = {},
    e;
  for (e = 0; e < this.vertices.length; e++) d[e] = [];
  var f, g;
  for (e = 0; e < this.triangles.length; e++) f = this.triangles[e], g = JSM.CalculateTriangleNormal(this.vertices[f.v0], this.vertices[f.v1], this.vertices[f.v2]), c.push(g), d[f.v0].push(e), d[f.v1].push(e), d[f.v2].push(e);
  for (e = 0; e <
    this.triangles.length; e++) b(this, e, c, d)
};
JSM.TriangleBody.prototype.Clone = function () {
  var a = new JSM.TriangleBody(this.name),
    b, c;
  for (b = 0; b < this.vertices.length; b++) a.vertices.push(this.vertices[b].Clone());
  for (b = 0; b < this.normals.length; b++) a.normals.push(this.normals[b].Clone());
  for (b = 0; b < this.uvs.length; b++) a.uvs.push(this.uvs[b].Clone());
  for (b = 0; b < this.triangles.length; b++) c = this.triangles[b], a.triangles.push({
    v0: c.v0,
    v1: c.v1,
    v2: c.v2,
    n0: c.n0,
...
JSM.ConvertTriangleBodyToOctree = function (a) {
  var b = new JSM.TriangleOctree(a.GetBoundingBox()),
    c, d, e, f;
  for (c = 0; c < a.TriangleCount(); c++) d = a.GetTriangle(c), e = a.GetVertex(d.v0), f = a.GetVertex(d.v1), d = a.GetVertex(d.v2), b.AddTriangle(e, f, d, {
    triangleIndex: c
  });
  return b
};
...
JSM.TriangleModel.prototype.VertexCount = function () {
  var a = 0,
    b, c;
  for (b = 0; b < this.bodies.length; b++) c = this.bodies[b], a += c.VertexCount();
  return a
};
JSM.TriangleModel.prototype.TriangleCount = function () {
  var a = 0,
    b, c;
  for (b = 0; b < this.bodies.length; b++) c = this.bodies[b], a += c.TriangleCount();
  return a
};
...
JSM.TriangleModel.prototype.FinalizeMaterials = function () {
  var a = {
    ...
    b, c;
  for (b = 0; b < this.materials.length; b++) c = this.materials[b], JSM.CopyObjectProperties(a, c, !1)
};
JSM.TriangleModel.prototype.FinalizeBodies = function () {
  var a, b;
  for (a = 0; a < this.bodies.length; a++) b = this.bodies[a], b.Finalize(this)
};
...
JSM.ConvertBodyToTriangleBody = function (a) {
  ...
  var c = new JSM.TriangleBody,
    d, e, f;
  for (d = 0; d < a.VertexCount(); d++) f = a.GetVertexPosition(d), c.AddVertex(f.x, f.y, f.z);
  var g, h, k, l;
  for (d = 0; d < a.PolygonCount(); d++)
    if (g = a.GetPolygon(d), h = g.VertexIndexCount(), !(3 > h))
      if (3 == h) f = g.GetVertexIndex(0), h = g.GetVertexIndex(1), l = g.GetVertexIndex(2), b(c, g, f, h, l);
      else {
        k =
          new JSM.Polygon;
        for (e = 0; e < h; e++) f = a.GetVertexPosition(g.GetVertexIndex(e)), k.AddVertex(f.x, f.y, f.z);
        e = JSM.CalculateBodyPolygonNormal(a, d);
        k = JSM.TriangulatePolygon(k, e);
        if (null !== k)
          for (e = 0; e < k.length; e++) l = k[e], f = g.GetVertexIndex(l[0]), h = g.GetVertexIndex(l[1]), l = g.GetVertexIndex(l[2]), b(c, g, f, h, l)
      } return c
};
JSM.ConvertModelToTriangleModel = function (a) {
  var b = new JSM.TriangleModel,
    c = a.GetMaterialSet(),
    d, e;
  for (d = 0; d < c.Count(); d++) e = c.GetMaterial(d), b.AddMaterial({
    name: "Material" + d,
  ...
  for (d = 0; d < a.BodyCount(); d++) c = a.GetBody(d), c = JSM.ConvertBodyToTriangleBody(c), b.AddBody(c);
  b.Finalize();
  return b
};
JSM.ConvertTriangleModelToJsonData = function (a) {
  function b(a, b, c) {
    var d = [],
      e = a.MaterialCount(),
      f;
    for (a = 0; a < b.VertexCount(); a++) f = b.GetVertex(a), c.vertices.push(f.x, f.y, f.z);
    for (a = 0; a < b.NormalCount(); a++) f = b.GetNormal(a), c.normals.push(f.x, f.y, f.z);
    for (a = 0; a < b.UVCount(); a++) f = b.GetUV(a), c.uvs.push(f.x, f.y);
    for (a = 0; a < e; a++) d.push([]);
    for (a = 0; a < b.TriangleCount(); a++) f = b.GetTriangle(a), void 0 === f.mat || (0 > f.mat || f.mat >= e) || d[f.mat].push(a);
    var q, p;
    for (a = 0; a < d.length; a++)
      if (q = d[a], 0 !== q.length) {
        ...
        for (e = 0; e < q.length; e++) f = b.GetTriangle(q[e]), p.parameters.push(f.v0, f.v1, f.v2, f.n0, f.n1, f.n2, f.u0, f.u1, f.u2);
        c.triangles.push(p)
      }
  }
  var c = {
  ...
  (function (a, b) {
    var c, d, e;
    for (c = 0; c < a.MaterialCount(); c++) d = a.GetMaterial(c), e = {
      ...
      opacity: d.opacity
    }, void 0 !== d.texture && null !== d.texture && (e.texture = JSM.ValueOrDefault(d.texture, null), e.offset = d.offset, e.scale =
      d.scale, e.rotation = d.rotation), b.push(e)
  })(a, c.materials);
  var d, e, f;
  for (d = 0; d < a.BodyCount(); d++) e = a.GetBody(d), 0 !== e.TriangleCount() && (f = {
    name: e.GetName(),
    vertices: [],
    normals: [],
    uvs: [],
    triangles: []
  }, b(a, e, f), c.meshes.push(f));
  return c
};
  ...
  function b(a, b, c) {
    function d(a, b, c, e, f, g) {
      ...
      void 0 === k && (a.triangles.push({
        material: h,
        parameters: []
      }), k = a.triangles.length - 1, c[h] = k);
      a = a.triangles[k].parameters;
      for (c = 0; c < b.parameters.length; c += 9) a.push(b.parameters[c] + e, b.parameters[c + 1] + e, b.parameters[c + 2] + e, b.parameters[c + 3] + f, b.parameters[c + 4] + f, b.parameters[c + 5] + f, b.parameters[c + 6] + g, b.parameters[c + 7] + g, b.parameters[c + 8] + g)
    }
    ...
    (function (a, b) {
      var c;
      for (c = 0; c < b.vertices.length; c++) a.vertices.push(b.vertices[c]);
      for (c = 0; c < b.normals.length; c++) a.normals.push(b.normals[c]);
      for (c = 0; c < b.uvs.length; c++) a.uvs.push(b.uvs[c])
    })(a, b);
    var r, s;
    for (r = 0; r < b.triangles.length; r++) s = b.triangles[r], d(a, s, c, e, f, g)
  }
  var c = {
      version: a.version,
    ...
    e = {},
    f, g;
  for (f = 0; f < a.meshes.length; f++) g = a.meshes[f], b(d, g, e);
  c.meshes.push(d);
  return c
};
JSM.RayTriangleIntersection = function (a, b, c, d) {
  ...
  var g = JSM.VectorCross(f, d),
    h = JSM.VectorDot(c, g);
  if (JSM.IsZero(h) || !JSM.IsPositive(h)) return null;
  var h = 1 / h,
    k = JSM.CoordSub(e, b);
  b = JSM.VectorDot(k, g) * h;
  if (JSM.IsLower(b, 0) || JSM.IsGreater(b, 1)) return null;
  c = JSM.VectorCross(k, c);
  g = JSM.VectorDot(f, c) * h;
  if (JSM.IsLower(g, 0) || JSM.IsGreater(b + g, 1)) return null;
  d = JSM.VectorDot(d, c) * h;
  if (!JSM.IsPositive(d) || a.IsLengthReached(d)) return null;
...
JSM.RayBoxIntersection = function (a, b, c) {
  ...
  var g = [0, 0, 0],
    ...
    k = !0,
    l;
  for (l = 0; 3 > l; l++) JSM.IsLower(f[l], b[l]) ? (g[l] = -1, h[l] = b[l], k = !1) : JSM.IsGreater(f[l], c[l]) ? (g[l] = 1, h[l] = c[l], k = !1) : g[l] = 0;
  l = null;
  if (k) return l = {
    position: d,
    distance: 0
  ...
  k = [0, 0, 0];
  for (l = 0; 3 > l; l++) 0 !== g[l] && !JSM.IsZero(e[l]) ? k[l] = (h[l] - f[l]) / e[l] : k[l] = -1;
  g = 0;
  for (l = 1; 3 > l; l++) JSM.IsLower(k[g], k[l]) && (g = l);
  if (JSM.IsNegative(k[g])) return null;
  var m = [0, 0, 0];
  for (l = 0; 3 > l; l++)
    if (g != l) {
      if (m[l] = f[l] + k[g] * e[l], JSM.IsLower(m[l], b[l]) || JSM.IsGreater(m[l], c[l])) return null
    } else m[l] = h[l];
...
JSM.RayOctreeIntersection = function (a, b, c) {
  ...
  JSM.TraverseOctreeNodes(b, function (b) {
    if (!f && e || !JSM.RayBoxIntersection(a, b.box.min, b.box.max)) return !1;
    var c;
    for (c = 0; c < b.triangles.length; c++) {
      ...
      if (null !== l) {
        e = !0;
        if (!f) return !1;
        if (null === d || l.distance < d.distance) d = l, d.userData = k.userData
      }
    }
    return !0
  });
  f && null !== d && (c.position = d.position, c.distance = d.distance, c.userData = d.userData);
  return e
};
JSM.RayTriangleBodyIntersection = function (a, b, c) {
  ...
  for (g = 0; g < b.TriangleCount(); g++)
    if (h = b.GetTriangle(g), k = b.GetVertex(h.v0), l = b.GetVertex(h.v1), h = b.GetVertex(h.v2), k = JSM.RayTriangleIntersection(a, k, l, h), null !== k) {
      e = !0;
      if (!f) break;
      if (null === d || k.distance < d.distance) d = k, d.triangleIndex = g
    } f && null !== d && (c.position = d.position, c.distance = d.distance, c.triangleIndex = d.triangleIndex);
  return e
};
JSM.RayTriangleModelIntersection = function (a, b, c) {
  ...
  for (g = 0; g < b.BodyCount(); g++)
    if (h = b.GetBody(g), k = f ? {} : null, JSM.RayTriangleBodyIntersection(a, h, k)) {
      e = !0;
      if (!f) break;
      if (null === d || k.distance < d.distance) d = k, d.bodyIndex = g
    } f && null !== d && (c.position = d.position, c.distance = d.distance, c.triangleIndex = d.triangleIndex, c.bodyIndex = d.bodyIndex);
  return e
};
JSM.RayTriangleModelIntersectionWithOctree = function (a, b, c) {
  var d = null,
    ...
    g, h, k;
  for (g = 0; g < b.BodyCount(); g++)
    if (h = b.GetBody(g), k = f ? {} : null, 20 < h.TriangleCount() ? (void 0 === h.octree && (h.octree = JSM.ConvertTriangleBodyToOctree(h)), h = JSM.RayOctreeIntersection(a, h.octree, k)) : h = JSM.RayTriangleBodyIntersection(a, h, k), h) {
      e = !0;
      if (!f) break;
      if (null === d || k.distance < d.distance) d = k, void 0 !== k.userData && (d.triangleIndex = k.userData.triangleIndex), d.bodyIndex = g
    } f && null !== d && (c.position = d.position,
    c.distance = d.distance, c.triangleIndex = d.triangleIndex, c.bodyIndex = d.bodyIndex);
  return e
};
...
JSM.Read3dsFile = function (a, b) {
  function c(a, c) {
    if (void 0 !== b.onLog && null !== b.onLog) b.onLog(a, c)
  }
  ...
  function e(a) {
    var b = [],
      c;
    for (c = 0; 3 > c; c++) b[c] = a.ReadFloat32();
    return b
  }
  ...
  (function (a, h) {
    function k(a, b, c) {
      ...
      var e = !1;
      f(a, b, function (b, c) {
        b == h.MAT_COLOR ? e || (d[0] = a.ReadUnsignedCharacter() / 255, d[1] = a.ReadUnsignedCharacter() / 255, d[2] = a.ReadUnsignedCharacter() / 255) : b == h.MAT_LIN_COLOR ? (d[0] = a.ReadUnsignedCharacter() / 255, d[1] = a.ReadUnsignedCharacter() / 255, d[2] = a.ReadUnsignedCharacter() / 255, e = !0) : b == h.MAT_COLOR_F ? e || (d[0] = a.ReadFloat32(), d[1] = a.ReadFloat32(), d[2] = a.ReadFloat32()) : b == h.MAT_LIN_COLOR_F ? (d[0] = a.ReadFloat32(), d[1] = a.ReadFloat32(), d[2] = a.ReadFloat32(), e = !0) : a.Skip(c - 6)
      });
      return d
    }
    ...
    function m(a, b, c, e) {
      ...
      b = a.GetPosition() + c - 6;
      f(a, b, function (b, c) {
        b == h.MAT_TEXMAP_NAME ? e.texture = d(a) : b == h.MAT_TEXMAP_UOFFSET ? e.offset[0] = a.ReadFloat32() : b == h.MAT_TEXMAP_VOFFSET ? e.offset[1] = a.ReadFloat32() : b == h.MAT_TEXMAP_USCALE ? e.scale[0] = a.ReadFloat32() : b == h.MAT_TEXMAP_VSCALE ? e.scale[1] =
          a.ReadFloat32() : b == h.MAT_TEXMAP_ROTATION ? e.rotation = a.ReadFloat32() : a.Skip(c - 6)
      })
    }
    ...
    function n(a, e, g) {
      ...
      var n = {},
        p = a.GetPosition() + g - 6;
      f(a, p, function (b, f) {
        b == h.MAT_NAME ? (c("Read material name chunk (" + e.toString(16) + ", " + g + ")", 3), n.name = d(a)) : b == h.MAT_AMBIENT ? (c("Read material ambient chunk (" + e.toString(16) + ", " + g + ")", 3), n.ambient = k(a, b, f)) : b == h.MAT_DIFFUSE ? (c("Read material diffuse chunk (" + e.toString(16) + ", " + g + ")", 3), n.diffuse = k(a, b, f)) : b == h.MAT_SPECULAR ?
          (c("Read material specular chunk (" + e.toString(16) + ", " + g + ")", 3), n.specular = k(a, b, f)) : b == h.MAT_SHININESS ? (c("Read material shininess chunk (" + e.toString(16) + ", " + g + ")", 3), n.shininess = l(a, b, f)) : b == h.MAT_SHININESS_STRENGTH ? (c("Read material shininess strength chunk (" + e.toString(16) + ", " + g + ")", 3), n.shininessStrength = l(a, b, f)) : b == h.MAT_TRANSPARENCY ? (c("Read material transparency chunk (" + e.toString(16) + ", " + g + ")", 3), n.transparency = l(a, b, f)) : b == h.MAT_TEXMAP ? (c("Read material texture map chunk (" + e.toString(16) +
            ", " + g + ")", 3), m(a, b, f, n)) : (c("Skip chunk (" + b.toString(16) + ", " + f + ")", 3), a.Skip(f - 6))
      });
      if (void 0 !== b.onMaterial && null !== b.onMaterial) b.onMaterial(n)
    }

    function q(a, e, g) {
      c("Read faces chunk (" + e.toString(16) + ", " + g + ")", 4);
      e = a.GetPosition() + g - 6;
      var k = a.ReadUnsignedInteger16(),
        l, m, n, p;
      for (g = 0; g < k; g++)
        if (l = a.ReadUnsignedInteger16(), m = a.ReadUnsignedInteger16(), n = a.ReadUnsignedInteger16(), p = a.ReadUnsignedInteger16(), void 0 !== b.onFace && null !== b.onFace) b.onFace(l, m, n, p);
      f(a, e, function (e, f) {
        if (e == h.TRI_MATERIAL) {
          c("Read face materials chunk (" +
            e.toString(16) + ", " + f + ")", 5);
          var g = d(a),
            l = a.ReadUnsignedInteger16(),
            m, n;
          for (m = 0; m < l; m++)
            if (n = a.ReadUnsignedInteger16(), void 0 !== b.onFaceMaterial && null !== b.onFaceMaterial) b.onFaceMaterial(n, g)
        } else if (e == h.TRI_SMOOTH) {
          c("Read face smoothing groups chunk (" + e.toString(16) + ", " + f + ")", 5);
          for (g = 0; g < k; g++)
            if (l = a.ReadUnsignedInteger32(), void 0 !== b.onFaceSmoothingGroup && null !== b.onFaceSmoothingGroup) b.onFaceSmoothingGroup(g, l)
        } else c("Skip chunk (" + e.toString(16) + ", " + f + ")", 5), a.Skip(f - 6)
      })
    }
    ...
    function p(a,
      ...
      if (void 0 !== b.onMesh && null !== b.onMesh) b.onMesh(d);
      d = a.GetPosition() + g - 6;
      f(a, d, function (d, e) {
        if (d == h.TRI_VERTEX) {
          c("Read vertices chunk (" + d.toString(16) + ", " + e + ")", 4);
          var f = a.ReadUnsignedInteger16(),
            g, k, l, m;
          for (g = 0; g < f; g++)
            if (k = a.ReadFloat32(), l = a.ReadFloat32(), m = a.ReadFloat32(), void 0 !== b.onVertex && null !== b.onVertex) b.onVertex(k, l, m)
        } else if (d == h.TRI_TEXVERTEX) {
          c("Read texture vertices chunk (" + d.toString(16) + ", " + e + ")", 4);
          f = a.ReadUnsignedInteger16();
          for (g = 0; g < f; g++)
            if (k = a.ReadFloat32(), l = a.ReadFloat32(), void 0 !== b.onTextureVertex && null !== b.onTextureVertex) b.onTextureVertex(k, l)
        } else if (d == h.TRI_FACE) q(a, d, e);
        else if (d == h.TRI_TRANSFORMATION) {
          c("Read transformation chunk (" + d.toString(16) + ", " + e + ")", 4);
          f = [];
          for (g = 0; 4 > g; g++) {
            for (k = 0; 3 > k; k++) f.push(a.ReadFloat32());
            3 > g ? f.push(0) : f.push(1)
          }
          if (void 0 !== b.onTransformation && null !== b.onTransformation) b.onTransformation(f)
        } else c("Skip chunk (" + d.toString(16) + ", " + e + ")", 4), a.Skip(e - 6)
      })
    }
    ...
    function r(a, b,
      ...
      var g = d(a);
      f(a, b, function (b, d) {
        b == h.OBJ_TRIMESH ? p(a, g, b, d) : (b == h.OBJ_LIGHT ? c("Skip light chunk (" + g + ", " + b.toString(16) + ", " + d + ")", 3) : b == h.OBJ_CAMERA ? c("Skip camera chunk (" + g + ", " + b.toString(16) + ", " + d + ")", 3) : c("Skip chunk (" + b.toString(16) + ", " + d + ")", 3), a.Skip(d - 6))
      })
    }
    ...
    function s(a, b, d) {
      ...
      b = a.GetPosition() + d - 6;
      f(a, b, function (b, d) {
        b == h.EDIT_MATERIAL ? n(a, b, d) : b == h.EDIT_OBJECT ?
          r(a, b, d) : (c("Skip chunk (" + b.toString(16) + ", " + d + ")", 2), a.Skip(d - 6))
      })
    }
    ...
    function v(a, g, k) {
      function l(a, b) {
        ...
        for (d = 0; d < k; d++) a.ReadInteger32(), f = a.ReadUnsignedInteger16(), 0 !== f && a.ReadFloat32(), b == h.OBJECT_ROTATION ? (g = a.ReadFloat32(), f = e(a), f[3] = g) : f = e(a), c.push(f);
        return c
      }
      ...
      f(a, g,
        function (b, f) {
          b == h.OBJECT_HIERARCHY ? (m.name = d(a), m.flags = a.ReadUnsignedInteger32(), m.userId = a.ReadUnsignedInteger16()) : b == h.OBJECT_PIVOT ? m.pivot = e(a) : b == h.OBJECT_POSITION ? m.positions = l(a, h.OBJECT_POSITION) : b == h.OBJECT_ROTATION ? m.rotations = l(a, h.OBJECT_ROTATION) : b == h.OBJECT_SCALE ? m.scales = l(a, h.OBJECT_SCALE) : b == h.OBJECT_ID ? m.nodeId = a.ReadUnsignedInteger16() : (c("Skip chunk (" + b.toString(16) + ", " + f + ")", 3), a.Skip(f - 6))
        });
      if (void 0 !== b.onObjectNode && null !== b.onObjectNode) b.onObjectNode(m)
    }
    ...
    function u(a,
      ...
      b = a.GetPosition() + d - 6;
      f(a, b, function (b, d) {
        b == h.OBJECT_NODE ? v(a, b, d) : (c("Skip chunk (" + b.toString(16) + ", " + d + ")", 2), a.Skip(d - 6))
      })
    }
    ...
    function t(a, b, d) {
      ...
      b = a.GetPosition() + d - 6;
      f(a, b, function (b, d) {
        b == h.EDIT3DS ? s(a, b, d) : b == h.KF3DS ? u(a, b, d) : (c("Skip chunk (" + b.toString(16) + ", " + d + ")", 1), a.Skip(d - 6))
      })
    }
    var y = a.GetByteLength();
    f(a, y, function (b, d) {
      b == h.MAIN3DS ? t(a, b, d) : (c("Skip chunk (" + b.toString(16) +
        ", " + d + ")", 0), a.Skip(d - 6))
    })
...
JSM.Convert3dsToJsonData = function (a, b) {
  ...
  JSM.Read3dsFile(a, {
    onMaterial: function (a) {
      if (void 0 === f[a.name]) {
        var b = d.AddMaterial({
            ...
            diffuse: a.diffuse,
            specular: a.specular,
            shininess: void 0 === a.shininess || null === a.shininess || void 0 === a.shininessStrength || null === a.shininessStrength ?
              0 : a.shininess * a.shininessStrength,
            opacity: void 0 === a.transparency || null === a.transparency ? 1 : 1 - a.transparency
          }),
          e = d.GetMaterial(b);
        if (void 0 !== a.texture && null !== a.texture) {
          var g = c(a.texture);
          null !== g && (g = new window.Blob([g]), g = window.URL.createObjectURL(g), e.texture = g, e.offset = a.offset, e.scale = a.scale, e.rotation = -a.rotation)
        }
        f[a.name] = b
      }
    },
    ...
    onFaceSmoothingGroup: function (a,
      b) {
  ...
  (function (a, b, c) {
    function d(a, b, c) {
      function e(a, b) {
        var c = b[0],
          ...
          f = b[2],
          g;
        for (g = 0; 4 > g; g++) a[0 + g] *= c, a[4 + g] *= d, a[8 + g] *= f;
        return a
      }
      ...
      function f(a, b) {
        var c = b[0],
          ...
          e = b[2],
          g;
        for (g = 0; 3 > g; g++) a[12 + g] += a[0 + g] * c + a[4 + g] * d + a[8 + g] * e;
        return a
      }

      function g(a, b) {
        var c, d;
        for (c = 0; c < a.VertexCount(); c++) d = a.GetVertex(c), d = JSM.ApplyTransformation(b, d), a.SetVertex(c, d.x, d.y, d.z)
      }

      function h(a, b, c) {
        var d = JSM.MatrixDeterminant(b);
        JSM.IsNegative(d) &&
          (b = JSM.MatrixClone(b), e(b, [-1, 1, 1]), c = JSM.MatrixMultiply(c, b), g(a, c))
      }

      function k(a, b) {
        if (void 0 !== a.matrix) return a.matrix;
        var c = JSM.MatrixIdentity(),
          d;
        d = 0 === a.positions.length ? [0, 0, 0] : a.positions[0];
        c = f(c, d);
        if (0 === a.rotations.length) d = [0, 0, 0, 0];
        else {
          d = a.rotations[0];
          var g = [0, 0, 0, 1],
            h = Math.sqrt(d[0] * d[0] + d[1] * d[1] + d[2] * d[2]);
          JSM.IsPositive(h) && (g = -0.5 * d[3], h = Math.sin(g) / h, g = [h * d[0], h * d[1], h * d[2], Math.cos(g)]);
          d = g
        }
        d = JSM.MatrixRotationQuaternion(d);
        c = JSM.MatrixMultiply(d, c);
        d = 0 === a.scales.length ? [0,
          0, 0, 0
        ] : a.scales[0];
        c = e(c, d);
        65535 != a.userId && (d = b.nodeIdToIndex[a.userId], void 0 !== d && (d = k(b.nodes[d], b), c = JSM.MatrixMultiply(c, d)));
        return a.matrix = c
      }
      var l = a.meshData;
      ...
      if (null !== l) {
        ...
        null !== l && (h(a, m, l), b = void 0 === b || null === b ? [0, 0, 0] : b.pivot, f(c, [-b[0], -b[1], -b[2]]), b = JSM.MatrixMultiply(l, c), g(a, b))
      }
    }
    ...
    function e(a, b, c, f) {
      ...
      f =
        a.meshData;
      var g, h, k;
      for (g = 0; g < a.TriangleCount(); g++) h = a.GetTriangle(g), b && (h.u0 = h.v0, h.u1 = h.v1, h.u2 = h.v2), k = f.faceToMaterial[g], void 0 !== k && (k = c[k], void 0 !== k && (h.mat = k)), k = f.faceToSmoothingGroup[g], void 0 !== k && 0 < k && (h.curve = k)
    }
    ...
    var g, h, v, u, t, y, B;
    for (g = 0; g < b.BodyCount(); g++)
      if (v = b.GetBody(g), u = v.meshData, 0 === u.objectNodes.length) e(v, null, c, a);
      else {
        y = a.nodes[u.objectNodes[0]];
        for (h = 1; h < u.objectNodes.length; h++) t = a.nodes[u.objectNodes[h]], B = f(b, v, g + 1, h + 1), B.meshData = v.meshData, e(B, t, c, a), g += 1;
        e(v, y, c, a)
      }
  })(h, d, f);
  d.Finalize();
...
JSM.ReadObjFile = function (a, b) {
  function c(a, c, d, e) {
    if (void 0 !== b.onMaterialComponent && null !== b.onMaterialComponent) b.onMaterialComponent(a, c, d, e)
  }

  function d(a, c, d) {
    if (void 0 !== b.onVertex && null !== b.onVertex) b.onVertex(a, c, d)
  }
  ...
  function f(a, c) {
    if (void 0 !== b.onTexCoord && null !== b.onTexCoord) b.onTexCoord(a, c)
  }
    ...
    if (0 !== a.length && "#" != a[0]) {
      ...
      if (!(0 === p.length || "#" == p[0][0])) {
        ...
        if ("g" == p[0]) {
          if (!(2 > p.length)) {
            var s = "";
            for (r = 1; r < p.length; r++) s += p[r], r < p.length - 1 && (s += " ");
            if (void 0 !== b.onMesh && null !== b.onMesh) b.onMesh(s)
          }
        } else if ("v" == p[0]) 4 > p.length || (h.vertexCount += 1, d(parseFloat(p[1]), parseFloat(p[2]), parseFloat(p[3])));
        else if ("vn" == p[0]) 4 > p.length || (h.normalCount += 1, e(parseFloat(p[1]),
          parseFloat(p[2]), parseFloat(p[3])));
        else if ("vt" == p[0]) 3 > p.length || (h.uvCount += 1, f(parseFloat(p[1]), parseFloat(p[2])));
        else if ("f" == p[0]) {
          if (!(4 > p.length)) {
            var s = [],
              v = [],
              u = [],
              t;
            for (r = 1; r < p.length; r++) t = p[r].split("/"), s.push(n(parseInt(t[0], 10), h.vertexCount)), 1 < t.length && 0 < t[1].length && u.push(n(parseInt(t[1], 10), h.uvCount)), 2 < t.length && 0 < t[2].length && v.push(n(parseInt(t[2], 10), h.normalCount));
            if (void 0 !== b.onFace && null !== b.onFace) b.onFace(s, v, u)
          }
        } else if ("usemtl" == p[0]) {
          if (!(2 > p.length) && void 0 !==
            b.onUseMaterial && null !== b.onUseMaterial) b.onUseMaterial(p[1])
        } else if ("newmtl" == p[0]) {
          if (!(2 > p.length) && void 0 !== b.onNewMaterial && null !== b.onNewMaterial) b.onNewMaterial(p[1])
        } else if ("Ka" == p[0] || "Kd" == p[0] || "Ks" == p[0]) 4 > p.length || c(p[0], parseFloat(p[1]), parseFloat(p[2]), parseFloat(p[3]));
        else if ("Ns" == p[0] || "Tr" == p[0] || "d" == p[0]) {
          if (!(2 > p.length) && void 0 !== b.onMaterialParameter && null !== b.onMaterialParameter) b.onMaterialParameter(p[0], p[1])
        } else if ("map_Kd" == p[0]) {
          if (!(2 > p.length) && (p = q(a, "map_Kd"),
              void 0 !== b.onMaterialTexture && null !== b.onMaterialTexture)) b.onMaterialTexture(p)
        } else "mtllib" == p[0] && !(2 > p.length) && (p = q(a, "mtllib"), p = g(p.trim()), null !== p && k(p))
      }
    }
  }
  ...
  function k(a, b) {
    var c = a.split("\n"),
      d, e;
    for (d = 0; d < c.length; d++) e = c[d].trim(), h(e, b)
  }
  if (void 0 === b || null === b) b = {};
  k(a, {
    vertexCount: 0,
...
JSM.ConvertObjToJsonData = function (a, b) {
  ...
  JSM.ReadObjFile(a, {
    ...
    onMaterialComponent: function (a, b, c, d) {
      null !== h && ("Ka" == a ? h.ambient = [b, c, d] : "Kd" == a ? h.diffuse = [b,
        c, d
      ] : "Ks" == a && (h.specular = [b, c, d]))
    },
    onMaterialParameter: function (a, b) {
      null !== h && ("Ns" == a ? (h.shininess = 0, JSM.IsPositive(b) && (h.shininess = (Math.log2(parseFloat(b)) - 1) / 10)) : "Tr" == a ? h.opacity = 1 - parseFloat(b) : "d" == a && (h.opacity = parseFloat(b)))
    },
    onMaterialTexture: function (a) {
      null !== h && (a = c(a), null !== a && (a = new window.Blob([a]), a = window.URL.createObjectURL(a), h.texture = a))
    },
    ...
    onFace: function (a, b, c) {
      ...
      var w, x, A, E, G = b.length == a.length,
        H = c.length == a.length,
        z = a.length;
      for (w = 0; w < z - 2; w++) x = e(f, l, q, a[0]), A = e(f, l, q, a[(w + 1) % z]), E = e(f, l, q, a[(w + 2) % z]), x = f.AddTriangle(x, A, E), x = f.GetTriangle(x), G && (x.n0 = g(f, m, p, b[0]), x.n1 = g(f, m, p, b[(w + 1) % z]), x.n2 = g(f, m, p, b[(w + 2) % z])), H && (x.u0 = h(f, n, r, c[0]), x.u1 = h(f, n, r, c[(w + 1) % z]), x.u2 = h(f, n, r, c[(w + 2) % z])), null !== k && (x.mat = k)
    },
    onFileRequested: c
  });
  d.Finalize();
...
JSM.ReadBinaryStlFile = function (a, b) {
  ...
  d.Skip(80);
  var e = d.ReadUnsignedInteger32(),
    f, g, h, k, l;
  for (f = 0; f < e; f++)
    if (l = c(d), g = c(d), h = c(d), k = c(d), d.Skip(2), void 0 !== b.onFace && null !== b.onFace) b.onFace(g, h, k, l)
};
JSM.ReadAsciiStlFile = function (a, b) {
  function c(a, c) {
    var d = a[c].trim();
    if (0 === d.length) return c + 1;
    d = d.split(/\s+/);
    if (0 === d.length) return c + 1;
    if ("solid" != d[0] && "facet" == d[0] && "normal" == d[1]) {
      if (5 > d.length) return -1;
      var d = [parseFloat(d[2]), parseFloat(d[3]), parseFloat(d[4])],
        e = [],
        l, m;
      for (l = c + 1; l < a.length && 3 > e.length; l++)
        if (m = a[l].trim(), 0 !== m.length && (m = m.split(/\s+/), 0 !== m.length && "vertex" == m[0]))
          if (4 > m.length) break;
          else m = [parseFloat(m[1]), parseFloat(m[2]), parseFloat(m[3])], e.push(m);
      l += 1;
      if (3 != e.length) return -1;
      if (void 0 !== b.onFace && null !== b.onFace) b.onFace(e[0], e[1], e[2], d);
      return l
    }
    return c + 1
  }
...
JSM.ImportFileList.prototype.InitFromURLs = function (a) {
  this.descriptors = [];
  var b, c, d;
  for (b = 0; b < a.length; b++) c = a[b], d = this.GetFileName(c), c = {
    originalObject: c,
    originalFileName: d,
...
JSM.ImportFileList.prototype.GetInputList = function () {
  ...
  for (b = 0; b < this.descriptors.length; b++) {
    ...
    d = c.originalObject;
    var e = this.isFile;
    c = ".OBJ" == c.extension || ".MTL" == c.extension ? !1 : !0;
    d = {
      originalObject: d,
      isFile: e,
      isArrayBuffer: c
...
JSM.ImportFileList.prototype.GetMainFileIndex = function () {
  ...
  for (a = 0; a < this.descriptors.length; a++)
    if (b = this.descriptors[a], this.IsSupportedExtension(b.extension)) return a;
  return -1
};
JSM.ImportFileList.prototype.GetFileIndexByName = function (a) {
  var b, c, d;
  for (b = 0; b < this.descriptors.length; b++)
    if (c = this.descriptors[b], d = this.GetFileName(a), c.fileName == d.toUpperCase()) return b;
  return -1
};
JSM.ImportFileList.prototype.IsSupportedExtension = function (a) {
  return ".3DS" == a || ".OBJ" == a || ".STL" == a ? !0 : !1
};
...
JSM.ConvertImportFileListToJsonData = function (a, b) {
  function c() {
    if (void 0 !== b.onError && null !== b.onError) b.onError()
  }

  function d(a, c) {
    if (void 0 !== b.onReady && null !== b.onReady) b.onReady(a, c)
  }

  function e(a, b, c, d) {
    var e = a.GetFileIndexByName(c);
    a = a.GetFileName(c);
    if (-1 == e) return d.missing.push(a), null; - 1 == d.requested.indexOf(a) && d.requested.push(a);
    return b[e]
  }
  ...
  if (-1 === f) c();
    ...
    try {
      ".3DS" ==
      g.extension ? JSM.LoadMultipleBuffers(k, function (b) {
        var g = b[f];
        ...
        a = a[f];
        if (null === a) c();
        else if (JSM.IsBinaryStlFile(a)) a = JSM.ConvertStlToJsonData(a, null), d(h, a);
        else {
          for (a =
            0; a < k.length; a++) k[a].isArrayBuffer = !1;
          JSM.LoadMultipleBuffers(k, function (a) {
            a = a[f];
            null === a ? c() : (a = JSM.ConvertStlToJsonData(null, a), d(h, a))
          })
        }
      })
    } catch (l) {
...
JSM.NextPowerOfTwo = function (a) {
  if (JSM.IsPowerOfTwo(a)) return a;
  for (var b = 1; b < a;) b *= 2;
  return b
};
JSM.ResizeImageToPowerOfTwoSides = function (a) {
  if (JSM.IsPowerOfTwo(a.width) && !JSM.IsPowerOfTwo(a.height)) return a;
...
JSM.WebGLInitContext = function (a) {
  if (null === a || void 0 === a.getContext) return null;
...
JSM.WebGLInitShaderProgram = function (a, b, c, d) {
  function e(a, b, c, d) {
    ...
    a.shaderSource(c, b);
    a.compileShader(c);
    return !a.getShaderParameter(c, a.COMPILE_STATUS) ? (void 0 !== d && null !== d && d(a.getShaderInfoLog(c)), null) : c
  }
  b = function (a, b, c, d) {
...
JSM.RenderBody.prototype.EnumerateMeshes = function (a) {
  for (var b in this.meshes) this.meshes.hasOwnProperty(b) && this.EnumerateTypedMeshes(b, a)
};
...
JSM.RenderBody.prototype.EnumerateTypedMeshes = function (a, b) {
  if (this.HasTypedMeshes(a)) {
    var c = this.meshes[a],
      d, e;
    for (d = 0; d < c.length; d++) e = c[d], b(e)
  }
};
JSM.RenderBody.prototype.EnumerateMeshesWithFlag = function (a, b) {
  for (var c in this.meshes) this.meshes.hasOwnProperty(c) && c & a && this.EnumerateTypedMeshes(c, b)
};
...
JSM.ShaderProgram.prototype.InitShaders = function () {
  ...
  function c(a, b, c, d) {
    if (d == JSM.ShaderType.Triangle || d == JSM.ShaderType.TexturedTriangle) {
      ...
      b.lightUniforms = [];
      var k;
      for (k = 0; k < c.maxLightCount; k++) b.lightUniforms.push({
      ...
      d == JSM.ShaderType.TexturedTriangle && (b.vertexUVAttribute = a.getAttribLocation(b, "aVertexUV"), b.samplerUniform = a.getUniformLocation(b, "uSampler"))
    } else if (d == JSM.ShaderType.Point || d == JSM.ShaderType.Line) {
      b.vertexPositionAttribute = a.getAttribLocation(b, "aVertexPosition");
      b.ambientLightColorUniform = a.getUniformLocation(b, "uAmbientLightColor");
      b.lightUniforms = [];
      for (k = 0; k < c.maxLightCount; k++) b.lightUniforms.push({
        diffuseColor: a.getUniformLocation(b, "uLights[" +
          k + "].diffuseColor")
      });
      b.materialUniforms = {
        ambientColor: a.getUniformLocation(b, "uMaterial.ambientColor"),
  ...
  this.shaders = {};
  if (!d(this.context, this.shaders, this.globalParams, JSM.ShaderType.Point) || !d(this.context, this.shaders, this.globalParams, JSM.ShaderType.Line) || !d(this.context, this.shaders, this.globalParams, JSM.ShaderType.Triangle) || !d(this.context, this.shaders, this.globalParams, JSM.ShaderType.TexturedTriangle)) return !1;
...
JSM.ShaderProgram.prototype.CompileMesh = function (a) {
  ...
  var d = null;
  a.HasNormalArray() && (d = b.createBuffer(), b.bindBuffer(b.ARRAY_BUFFER, d), b.bufferData(b.ARRAY_BUFFER, a.GetNormalArray(), b.STATIC_DRAW), d.itemSize = 3, d.numItems = a.NormalCount());
  var e = null;
  a.HasUVArray() && (e = b.createBuffer(), b.bindBuffer(b.ARRAY_BUFFER, e), b.bufferData(b.ARRAY_BUFFER,
    a.GetUVArray(), b.STATIC_DRAW), e.itemSize = 2, e.numItems = a.UVCount());
  a.SetBuffers(c, d, e)
};
...
JSM.ShaderProgram.prototype.SetParameters = function (a, b, c, d) {
  ...
  if (this.currentType == JSM.ShaderType.Triangle || this.currentType == JSM.ShaderType.TexturedTriangle) {
    ...
    for (a = 0; a < this.globalParams.maxLightCount; a++) g = a < b.length ? b[a] : this.globalParams.noDirectionalLight, h = JSM.ApplyRotation(c, g.direction), e.uniform3f(f.lightUniforms[a].diffuseColor, g.diffuse[0], g.diffuse[1], g.diffuse[2]), e.uniform3f(f.lightUniforms[a].specularColor,
      g.specular[0], g.specular[1], g.specular[2]), e.uniform3f(f.lightUniforms[a].direction, h.x, h.y, h.z);
    ...
    e.uniform3f(f.ambientLightColorUniform, a.color[0], a.color[1], a.color[2]);
    for (a = 0; a < this.globalParams.maxLightCount; a++) g = a < b.length ? b[a] : this.globalParams.noDirectionalLight, e.uniform3f(f.lightUniforms[a].diffuseColor, g.diffuse[0], g.diffuse[1],
      g.diffuse[2]);
    e.uniformMatrix4fv(f.pMatrixUniform, !1, d);
    e.uniformMatrix4fv(f.vMatrixUniform, !1, c)
  }
...
JSM.ShaderProgram.prototype.DrawArrays = function (a, b, c, d, e) {
  ...
  else if (this.currentType == JSM.ShaderType.Point || this.currentType == JSM.ShaderType.Line) f.uniform3f(g.materialUniforms.ambientColor, a.ambient[0], a.ambient[1], a.ambient[2]), f.uniform3f(g.materialUniforms.diffuseColor, a.diffuse[0], a.diffuse[1], a.diffuse[2]), f.uniformMatrix4fv(g.tMatrixUniform,
...
JSM.Renderer.prototype.InitContext = function (a) {
  this.canvas = a;
  if (null === this.canvas || void 0 === this.canvas.getContext) return !1;
  this.context = this.canvas.getContext("webgl") || this.canvas.getContext("experimental-webgl");
  if (null === this.context) return !1;
...
JSM.Renderer.prototype.AddLight = function (a) {
  ...
  if (this.directionalLights.length >= b) return -1;
  this.directionalLights.push(a);
  return this.directionalLights.length - 1
};
JSM.Renderer.prototype.RemoveLight = function (a) {
  a = this.directionalLights.indexOf(a); - 1 != a && this.directionalLights.splice(a, 1)
};
...
JSM.Renderer.prototype.AddBodies = function (a, b) {
  var c, d;
  for (c = 0; c < a.length; c++) d = a[c], this.AddBody(d, b)
};
JSM.Renderer.prototype.EnumerateBodies = function (a) {
  var b;
  for (b = 0; b < this.bodies.length; b++) a(this.bodies[b])
};
JSM.Renderer.prototype.RemoveBody = function (a) {
  a = this.bodies.indexOf(a); - 1 != a && this.bodies.splice(a, 1)
};
  ...
  this.EnumerateBodies(function (a) {
    ...
    a.EnumerateMeshesWithFlag(JSM.RenderMaterialFlags.Triangle, function (c) {
      var k = c.VertexCount(),
        l, m, n, q;
      for (l =
        0; l < k; l += 3) m = c.GetTransformedVertex(l + 0, b), n = c.GetTransformedVertex(l + 1, b), q = c.GetTransformedVertex(l + 2, b), m = JSM.RayTriangleIntersection(d, m, n, q), null !== m && e.push({
        renderBody: a,
        renderMesh: c,
  ...
  function b(a, b, c, g) {
    function h(a) {
      if (a & JSM.RenderMaterialFlags.Triangle) {
        if (a & JSM.RenderMaterialFlags.Textured) return JSM.ShaderType.TexturedTriangle;
        if (!(a & JSM.RenderMaterialFlags.Textured)) return JSM.ShaderType.Triangle
      } else {
        if (a & JSM.RenderMaterialFlags.Line) return JSM.ShaderType.Line;
        if (a & JSM.RenderMaterialFlags.Point) return JSM.ShaderType.Point
      }
      return null
    }
    var k = null;
    a.EnumerateBodies(function (l) {
      if (l.HasTypedMeshes(b)) {
        ...
        l.EnumerateTypedMeshes(b, function (l) {
          null === k && (k = h(b), a.shader.UseShader(k), a.shader.SetParameters(a.ambientLight, a.directionalLights, c, g));
          var q = l.GetMaterial(),
            p = l.GetVertexBuffer(),
            r = l.GetNormalBuffer();
          l = l.GetUVBuffer();
...
JSM.PointCloudRenderer.prototype.InitShaders = function () {
  ...
  if (!this.context.getProgramParameter(this.shader, this.context.LINK_STATUS)) return !1;
  ...
  JSM.ExplodeBody(a, b, {
    ...
    onTriangle: function (a, b, c, d, e, f, s, v, u) {
      ...
      h.push(e.x, e.y,
        e.z);
      h.push(f.x, f.y, f.z);
      null !== s && (null !== v && null !== u) && (k.push(s.x, s.y), k.push(v.x, v.y), k.push(u.x, u.y))
    }
  });
  return f
};
JSM.ConvertModelToRenderBodies = function (a, b) {
  var c = [],
    d = a.GetMaterialSet(),
    e, f;
  for (e = 0; e < a.BodyCount(); e++) f = a.GetBody(e), f = JSM.ConvertBodyToRenderBody(f, d, b), c.push(f);
  return c
};
JSM.ConvertJSONDataToRenderBodies = function (a, b) {
  function c(a, b) {
    function c(a, b, d) {
      ...
      h && (d.SetType(JSM.RenderMaterialFlags.Triangle + JSM.RenderMaterialFlags.Textured), d.texture = g.texture, d.ambient = [1, 1, 1], d.diffuse = [1, 1, 1]);
      d = new JSM.RenderMesh(d);
      var k = [],
        l = [],
        m = [],
        n;
      for (n = 0; n < b.parameters.length; n += 9) f(k, a.vertices, b.parameters, n, 3), f(l, a.normals, b.parameters, n + 3, 3), f(m, a.uvs, b.parameters, n + 6, 2);
      if (h) {
        a = g.offset || [0, 0];
        b = g.scale || [1, 1];
        g = g.rotation || 0;
        for (n = 0; n < m.length; n += 2) h = e(m[n +
          0], m[n + 1], a, b, g), m[n + 0] = h.x, m[n + 1] = -h.y
      }
      d.SetVertexArray(k);
      d.SetNormalArray(l);
      d.SetUVArray(m);
    ...
    var d = new JSM.RenderBody,
      e, f;
    for (e = 0; e < a.triangles.length; e++) f = a.triangles[e], f = c(a, f, b), d.AddMesh(f);
    return d
  }
  var d = [],
    e = a.materials;
...
JSM.Mouse.prototype.SetCurrent = function (a, b) {
  var c = a.clientX,
    d = a.clientY;
  if (void 0 !== b.getBoundingClientRect) var e = b.getBoundingClientRect(),
    c = c - e.left,
    d = d - e.top;
  void 0 !== window.pageXOffset && void 0 !== window.pageYOffset && (c += window.pageXOffset, d += window.pageYOffset);
...
JSM.Touch.prototype.Start = function (a, b) {
  0 !== a.touches.length && (this.down = !0, this.fingers = a.touches.length, this.SetCurrent(a, b), this.prev = this.curr.Clone())
};
JSM.Touch.prototype.Move = function (a, b) {
  0 !== a.touches.length && (this.fingers = a.touches.length, this.SetCurrent(a, b), this.diff = JSM.CoordSub2D(this.curr, this.prev), this.prev = this.curr.Clone())
};
JSM.Touch.prototype.End = function (a, b) {
  0 !== a.touches.length && (this.down = !1, this.SetCurrent(a, b))
};
JSM.Touch.prototype.SetCurrent = function (a, b) {
  function c(a, b) {
    var c = a.pageX,
      d = a.pageY;
    if (void 0 !== b.getBoundingClientRect) var k = b.getBoundingClientRect(),
      c = c - k.left,
      d = d - k.top;
    void 0 !== window.pageXOffset && void 0 !== window.pageYOffset && (c += window.pageXOffset, d += window.pageYOffset);
    return new JSM.Coord2D(c, d)
  }
  if (1 == a.touches.length || 3 == a.touches.length) this.curr = c(a.touches[0], b);
...
JSM.OrderPolygons = function (a, b, c) {
  ...
  for (n = 0; n < m; n++) {
    k.push(n);
    l.push([]);
    for (q = 0; q < m; q++) l[n].push(null)
  }(function () {
    var k = JSM.CoordSub(c, b).Normalize(),
      k = JSM.GetPlaneFromCoordAndDirection(b, k),
      l, m, n, q, t, y;
    for (l = 0; l < a.PolygonCount(); l++) {
      t = JSM.Inf;
      y = -JSM.Inf;
      n = a.GetPolygon(l);
      for (m = 0; m < n.VertexIndexCount(); m++) q = a.GetVertexPosition(n.GetVertexIndex(m)), q = k.CoordDistance(q), JSM.IsLower(q, t) && (t = q), JSM.IsGreater(q, y) && (y = q);
      d.push(t);
      e.push(y);
      m = a.GetPolygon(l);
      n = new JSM.Coord(0, 0, 0);
      y = t = void 0;
      for (t = 0; t < m.VertexIndexCount(); t++) y = a.GetVertexPosition(m.GetVertexIndex(t)), n = JSM.CoordAdd(n, y);
  ...
  (function () {
    ...
    for (c = 0; c < b - 1; c++)
      for (f = 0; f < b - c - 1; f++) {
        ...
        if (null !== l[g][m]) g = l[g][m];
          ...
          if (n = JSM.IsLowerOrEqual(d[g], e[m])) {
            ...
            for (var B = h[q], C = void 0, w = void 0, x = !0, A = a.GetPolygon(g), C = 0; C < A.VertexIndexCount(); C++)
              if (w = a.GetVertexPosition(A.GetVertexIndex(C)), B.CoordPosition(w) === JSM.CoordPlanePosition.CoordInFrontOfPlane) {
                x = !1;
                break
              } if (x) n = !1;
            else {
              ...
              for (C = 0; C < q.VertexIndexCount(); C++)
                if (w = a.GetVertexPosition(q.GetVertexIndex(C)), n.CoordPosition(w) === JSM.CoordPlanePosition.CoordAtBackOfPlane) {
                  B = !1;
                  break
                } n = B ? !1 : !0
            }
        ...
        g && (g = k, m = f + 1, n = g[f], g[f] = g[m], g[m] = n)
      }
  })();
  return k
};
...
JSM.CanvasDrawer.prototype.DrawPolygon = function (a, b, c) {
  ...
  this.context.beginPath();
  for (d = 0; d < a.VertexCount(); d++) b = a.GetVertex(d), 0 === d ? this.context.moveTo(b.x, this.canvas.height - b.y) : this.context.lineTo(b.x, this.canvas.height - b.y);
  this.context.closePath();
  this.context.fill();
  if (c)
    for (d = 0; d < a.VertexCount(); d++) b = a.GetVertex(d), c = a.GetVertex(d < a.VertexCount() - 1 ? d + 1 : 0), this.DrawLine(b, c)
};
...
JSM.SVGDrawer.prototype.Clear = function () {
  for (; this.svgObject.lastChild;) this.svgObject.removeChild(this.svgObject.lastChild)
};
...
JSM.SVGDrawer.prototype.DrawPolygon = function (a, b) {
  var c = "",
    d = this.GetHeight(),
    e, f;
  for (e = 0; e < a.VertexCount(); e++) f = a.GetVertex(e), c = c + f.x + ", " + (d - f.y), e < a.VertexCount() - 1 && (c += ", ");
...
JSM.DrawProjectedBody = function (a, b, c, d, e, f) {
  ...
  function h(b) {
    var c = new JSM.Polygon2D,
      d, e;
    for (d = 0; d < b.VertexIndexCount(); d++) e = a.GetVertexPosition(b.GetVertexIndex(d)), g(c, e);
    return c
  }
  e && f.Clear();
  e = f.GetWidth();
  var k = f.GetHeight(),
    ...
    q = c.fieldOfView,
    p = e / k,
    r = c.nearClippingPlane,
    s = c.farClippingPlane,
    v = [0, 0, e, k],
    u, t, y, B;
  if ("HiddenLinePainter" == d) {
    ...
    if (void 0 === b || null === b) b =
      new JSM.MaterialSet;
    for (c = 0; c < d.length; c++) u = a.GetPolygon(d[c]), t = h(u), y = u.GetMaterialIndex(), B = b.GetMaterial(y).diffuse, f.DrawPolygon(t, B, !0)
    ...
    JSM.TraverseBSPTreeForEyePosition(d, c.eye, function (c) {
      var d = c.polygon,
        e = new JSM.Polygon2D,
        h, k;
      for (h = 0; h < d.VertexCount(); h++) k = d.GetVertex(h), g(e, k);
      t = e;
    ...
    if (void 0 === b || null === b) b = new JSM.MaterialSet;
    for (c = 0; c < a.PolygonCount(); c++) u = a.GetPolygon(c), t = h(u), t.GetOrientation() == JSM.Orientation.CounterClockwise && (y = u.GetMaterialIndex(), B = b.GetMaterial(y).diffuse, f.DrawPolygon(t, B, !0))
  } else if ("Wireframe" == d) {
    var C, w, x, A = [];
    for (c = 0; c < a.PolygonCount(); c++) {
      w = C = null;
      ...
      for (d = 0; d <= k; d++) x = u.GetVertexIndex(d % k), e = a.GetVertexPosition(x), t = JSM.Project(e, l, m, n, q *
        JSM.DegRad, p, r, s, v), null !== C && (null !== w && void 0 === A[[w, x]]) && (f.DrawLine(C, t), A[[w, x]] = !0, A[[x, w]] = !0), w = x, C = t
    }
  }
  return !0
};
...
JSM.Navigation.prototype.Init = function (a, b, c, d) {
  ...
  this.canvas.addEventListener &&
    (this.canvas.addEventListener("mousedown", function (a) {
      e.OnMouseDown(a)
    }, !1), this.canvas.addEventListener("DOMMouseScroll", function (a) {
      e.OnMouseWheel(a)
    }, !1), this.canvas.addEventListener("mousewheel", function (a) {
        console.log(e,a, '=====')
      e.OnMouseWheel(a)
      ...
      e.OnTouchEnd(a)
    }, !1), this.canvas.addEventListener("contextmenu",
      function (a) {
        e.OnContextMenu(a)
      }, !1));
...
JSM.Navigation.prototype.Orbit = function (a, b) {
  ...
  this.cameraFixUp ? (e = e.AngleTo(this.camera.up) + d, JSM.IsGreater(e, 0) && JSM.IsLower(e, Math.PI) && (this.camera.eye.Rotate(f, -d, this.orbitCenter), g && this.camera.center.Rotate(f, -d, this.orbitCenter)), this.camera.eye.Rotate(this.camera.up, -c, this.orbitCenter), g && this.camera.center.Rotate(this.camera.up,
...
JSM.Navigation.prototype.Zoom = function (a) {
  var b = JSM.CoordSub(this.camera.center, this.camera.eye),
    c = b.Length(),
    d = 0 < a;
  if (d && null !== this.cameraNearDistanceLimit && c < this.cameraNearDistanceLimit || !d && null !== this.cameraFarDistanceLimit && c > this.cameraFarDistanceLimit) return 0;
...
JSM.Navigation.prototype.ResizeCallback = function () {
  void 0 !== this.resizeCallback && null !== this.resizeCallback && (this.fullscreen && (this.canvas.width = window.innerWidth, this.canvas.height = window.innerHeight), this.resizeCallback())
};
...
JSM.Navigation.prototype.OnTouchMove = function (a) {
  ...
  if (this.touch.down) {
    ...
    if (1 == this.touch.fingers) {
      ...
      if (!this.cameraEnableZoom) return;
...
JSM.SoftwareViewer.prototype.GetBoundingBox = function () {
  ...
  for (c = 0; c < this.bodies.length; c++) {
    e = this.bodies[c][0];
    for (d = 0; d < e.VertexCount(); d++) f = e.GetVertex(d), a.x = JSM.Minimum(a.x, f.position.x), a.y = JSM.Minimum(a.y, f.position.y), a.z = JSM.Minimum(a.z, f.position.z), b.x = JSM.Maximum(b.x, f.position.x), b.y = JSM.Maximum(b.y, f.position.y), b.z = JSM.Maximum(b.z, f.position.z)
  }
  return new JSM.Box(a, b)
};
JSM.SoftwareViewer.prototype.GetBoundingSphere = function () {
  ...
  for (c = 0; c < this.bodies.length; c++) {
    e = this.bodies[c][0];
    for (d = 0; d < e.VertexCount(); d++) f = e.GetVertex(d), f = a.DistanceTo(f.position), JSM.IsGreater(f, b) && (b = f)
  }
  return new JSM.Sphere(a, b)
};
...
JSM.SoftwareViewer.prototype.Draw = function () {
  var a, b;
  this.drawer.Clear();
  for (a = 0; a < this.bodies.length; a++) b = this.bodies[a], JSM.DrawProjectedBody(b[0], b[1], this.camera, this.drawMode, !1, this.drawer);
  return !0
};
...
JSM.SpriteViewer.prototype.InitCallbacks = function (a) {
  ...
  void 0 !== a && (void 0 !== a.onDrawStart && (this.callbacks.onDrawStart = a.onDrawStart), void 0 !== a.onPointDraw && (this.callbacks.onPointDraw = a.onPointDraw), void 0 !== a.onDrawEnd && (this.callbacks.onDrawEnd = a.onDrawEnd));
  return !0
};
...
JSM.SpriteViewer.prototype.NearestPointUnderPosition = function (a, b, c) {
  ...
  var d = JSM.Inf,
    e, f, g;
  for (e = 0; e < this.projected.length; e++) f = this.projected[e], g = b.DistanceTo(new JSM.Coord2D(f.position.x, f.position.y)), JSM.IsLower(g, a) && JSM.IsLower(g, d) && (c = f.originalIndex, d = g);
  return c
};
...
JSM.SpriteViewer.prototype.GetBoundingBox = function () {
  var a = new JSM.Coord(JSM.Inf, JSM.Inf, JSM.Inf),
    b = new JSM.Coord(-JSM.Inf, -JSM.Inf, -JSM.Inf),
    c, d;
  for (c = 0; c < this.points.length; c++) d = this.points[c], a.x = JSM.Minimum(a.x, d.x), a.y = JSM.Minimum(a.y, d.y), a.z = JSM.Minimum(a.z, d.z), b.x = JSM.Maximum(b.x, d.x), b.y = JSM.Maximum(b.y, d.y), b.z = JSM.Maximum(b.z, d.z);
  return new JSM.Box(a, b)
};
JSM.SpriteViewer.prototype.GetBoundingSphere = function () {
  var a = this.GetCenter(),
    b = 0,
    c, d;
  for (c = 0; c < this.points.length; c++) d = this.points[c], d = a.DistanceTo(d), JSM.IsGreater(d, b) && (b = d);
  return new JSM.Sphere(a, b)
};
JSM.SpriteViewer.prototype.Draw = function () {
  if (null !== this.callbacks.onDrawStart) this.callbacks.onDrawStart(this.canvas);
  var a = this.canvas.width / this.canvas.height,
    b = [0, 0, this.canvas.width, this.canvas.height];
  this.projected = [];
  var c, d;
  for (c = 0; c < this.points.length; c++) d = this.points[c], d = JSM.Project(d, this.camera.eye, this.camera.center, this.camera.up, this.camera.fieldOfView * JSM.DegRad, a, this.camera.nearClippingPlane, this.camera.farClippingPlane, b), d.y = this.canvas.height - d.y, null !== d && this.projected.push({
    position: d,
    originalIndex: c
  });
  ...
  for (c = 0; c < this.projected.length; c++)
    if (null !== this.callbacks.onPointDraw) this.callbacks.onPointDraw(this.canvas, this.projected[c].originalIndex, this.projected[c].position);
  if (null !== this.callbacks.onDrawEnd) this.callbacks.onDrawEnd(this.canvas);
  return !0
};
JSM.Viewer = function () {
...
JSM.Viewer.prototype.EnableCameraLight = function () {
  null === this.cameraLight && (this.cameraLight = new JSM.RenderDirectionalLight(8355711, 16777215, new JSM.Vector(1, 0, 0)), this.AddLight(this.cameraLight))
};
JSM.Viewer.prototype.DisableCameraLight = function () {
  null !== this.cameraLight && (this.RemoveLight(this.cameraLight), this.cameraLight = null)
};
...
JSM.Viewer.prototype.GetBoundingBox = function () {
  ...
  this.renderer.EnumerateBodies(function (c) {
    ...
    c.EnumerateMeshes(function (c) {
      var f, g;
      for (f = 0; f < c.VertexCount(); f++) g = c.GetTransformedVertex(f, d), a.x = JSM.Minimum(a.x, g.x), a.y = JSM.Minimum(a.y, g.y), a.z = JSM.Minimum(a.z, g.z), b.x = JSM.Maximum(b.x, g.x), b.y = JSM.Maximum(b.y, g.y), b.z = JSM.Maximum(b.z, g.z)
    })
  });
  return new JSM.Box(a, b)
};
JSM.Viewer.prototype.GetBoundingSphere = function () {
  ...
  this.renderer.EnumerateBodies(function (c) {
    ...
    c.EnumerateMeshes(function (c) {
      var f, g;
      for (f = 0; f < c.VertexCount(); f++) g = c.GetTransformedVertex(f, d), g = a.DistanceTo(g), JSM.IsGreater(g, b) && (b = g)
    })
  });
  return new JSM.Sphere(a, b)
};
...
JSM.PointCloudViewer.prototype.GetBoundingBox = function () {
  ...
  for (c = 0; c < this.renderer.points.length; c++) {
    ...
    for (d = 0; d < e.length; d += 3) f = new JSM.Coord(e[d], e[d + 1], e[d + 2]), a.x = JSM.Minimum(a.x, f.x), a.y = JSM.Minimum(a.y, f.y), a.z = JSM.Minimum(a.z, f.z), b.x = JSM.Maximum(b.x, f.x), b.y = JSM.Maximum(b.y, f.y), b.z = JSM.Maximum(b.z, f.z)
  }
  return new JSM.Box(a, b)
};
JSM.PointCloudViewer.prototype.GetBoundingSphere = function () {
  ...
  for (c = 0; c < this.renderer.points.length; c++) {
    e = this.renderer.points[c].pointArray;
    for (d = 0; d < e.length; d += 3) f = new JSM.Coord(e[d], e[d + 1], e[d + 2]), f = a.DistanceTo(f), JSM.IsGreater(f, b) && (b = f)
  }
  return new JSM.Sphere(a, b)
};
...
JSM.GenerateSolidWithRadius = function (a, b) {
  var c = new JSM.Body,
    d = !0;
  "Tetrahedron" === a ? c = JSM.GenerateTetrahedron() : "Hexahedron" === a ? c = JSM.GenerateHexahedron() : "Octahedron" === a ? c = JSM.GenerateOctahedron() : "Dodecahedron" === a ? c = JSM.GenerateDodecahedron() : "Icosahedron" === a ? c = JSM.GenerateIcosahedron() : "TruncatedTetrahedron" === a ? c = JSM.GenerateTruncatedTetrahedron() : "Cuboctahedron" === a ? c = JSM.GenerateCuboctahedron() : "TruncatedCube" === a ? c = JSM.GenerateTruncatedCube() : "TruncatedOctahedron" === a ? c = JSM.GenerateTruncatedOctahedron() :
    ...
    a ? (c = JSM.GenerateGreatStellatedDodecahedron(), d = !1) : "SmallTriakisOctahedron" === a ? (c = JSM.GenerateSmallTriakisOctahedron(), d = !1) : "StellaOctangula" === a ? (c = JSM.GenerateStellaOctangula(), d = !1) : "TriakisTetrahedron" === a && (c = JSM.GenerateTriakisTetrahedron(), d = !1);
  if (0 < c.VertexCount()) {
    var e = 0;
    if (d) e = c.GetVertexPosition(0).Length();
    else
      for (var f, d = 0; d < c.VertexCount(); d++) f = c.GetVertexPosition(d).Length(), JSM.IsGreater(f, e) && (e = f);
    e = b / e;
    for (d = 0; d < c.VertexCount(); d++) f = c.GetVertex(d), f.position.MultiplyScalar(e)
  }
  return c
};
...
JSM.GenerateRhombicuboctahedron = function () {
  ...
  JSM.AddPolygonToBody(a, [8, 16, 17,
    9
  ]);
...
JSM.GenerateTruncatedDodecahedron = function () {
  ...
  JSM.AddPolygonToBody(a, [5,
    7, 27, 51, 59, 35, 34, 58, 50, 26
  ]);
...
JSM.GenerateTruncatedIcosahedron = function () {
  ...
  JSM.AddPolygonToBody(a, [12, 36, 28, 52,
    20, 44
  ]);
...
JSM.GenerateTruncatedIcosidodecahedron = function () {
  ...
  JSM.AddPolygonToBody(a,
    [19, 43, 91, 105, 57, 61, 109, 94, 46, 22]);
...
JSM.GenerateSnubDodecahedron = function () {
  ...
  JSM.AddPolygonToBody(a, [0, 12, 24, 36,
    48
  ]);
...
JSM.AddCumulatedPolygonToBody = function (a, b, c) {
  var d = new JSM.Coord(0, 0, 0),
    ...
    f = [],
    g;
  for (g = 0; g < b.length; g++) f.push(a.GetVertexPosition(b[g]));
  ...
  d = b.length;
  for (e = 0; e < d; e++) f = b[e], g = b[e < d - 1 ? e + 1 : 0], JSM.AddPolygonToBody(a, [f, g, c])
};
...
JSM.GenerateCumulatedHexahedron = function (a) {
  ...
  JSM.AddCumulatedPolygonToBody(b,
    [2, 6, 7, 4], a);
...
JSM.GenerateCumulatedDodecahedron = function (a) {
  ...
  JSM.AddCumulatedPolygonToBody(b, [2, 10, 6, 15,
    13
  ], a);
...
JSM.GenerateLegoBrick = function (a, b, c, d, e, f, g) {
  function h(a, b) {
    var c, d;
    for (c = 0; c < a.VertexCount(); c++) d = a.GetVertex(c), d.position = JSM.CoordAdd(d.position, b)
  }
  ...
  k.Merge(t);
  for (t = 0; 4 > t; t++) u[t].z = n - c;
  t = JSM.GeneratePrism(u, l, c, !0, null);
  k.Merge(t);
  if (d)
    for (t = 0; t < a; t++)
      for (u = 0; u < b; u++) d = new JSM.Coord(m * t + m / 2, m * u + m / 2, n + p / 2), l = JSM.GenerateCylinder(q / 2, p, f, !0, g), h(l, d), k.Merge(l);
  if (e)
    if (1 === a && 1 < b || 1 === b && 1 < a) {
      e = b;
      q = !0;
      a > b && (e = a, q = !1);
      for (t = 0; t < e - 1; t++) d = q ? new JSM.Coord(m / 2, m * (t + 1), (n - c) / 2) : new JSM.Coord(m * (t + 1), m / 2, (n - c) / 2), l = JSM.GenerateCylinder(r /
        2, n - c, f, !0, g), h(l, d), k.Merge(l)
    } else if (1 < a && 1 < b)
    for (t = 0; t < a - 1; t++)
      for (u = 0; u < b - 1; u++) d = new JSM.Coord(m * (t + 1), m * (u + 1), (n - c) / 2), l = JSM.GenerateCylinderShell(s / 2, n - c, v, f, !0, g), h(l, d), k.Merge(l);
...
JSM.GenerateConvexHullBody = function (a) {
  var b = new JSM.Body,
    c = JSM.ConvexHull3D(a),
    d = {},
    e, f, g, h;
  for (e = 0; e < c.length; e++) {
    g = c[e];
    for (f = 0; f < g.length; f++) h = g[f], h in d || (d[h] = b.VertexCount(), b.AddVertex(new JSM.BodyVertex(a[h])))
  }
  for (e = 0; e < c.length; e++) {
    g = c[e];
    a = [];
    for (f = 0; f < g.length; f++) h = g[f], a.push(d[h]);
...
JSM.GenerateSuperShape = function (a, b, c, d, e, f, g, h, k, l, m, n, q, p) {
  ...
  q = JSM.GenerateSphere(1,
    q, p);
  var u, t;
  for (p = 0; p < q.VertexCount(); p++) u = q.GetVertex(p), t = u.position, t = r(t), t = v(t[1], t[2]), u.SetPosition(t);
  return q
};
JSM.CatmullClarkSubdivisionOneIteration = function (a) {
  ...
  (function (a, b, c) {
    var d, e;
    for (d = 0; d < c.verts.length; d++) e = a.GetVertexPosition(d), b.AddVertex(new JSM.BodyVertex(e.Clone()))
  })(a, b, c);
  (function (a, b, c, d) {
    var e, m, n, q, p;
    for (e = 0; e < c.pgons.length; e++) {
      ...
      for (m = 0; m < n.verts.length; m++) q = a.GetVertexPosition(n.verts[m]), p = JSM.CoordAdd(p, q);
  ...
  (function (a, b, c, d, e) {
    ...
    for (m = 0; m < c.edges.length; m++) {
      ...
      if (c.IsContourEdge(q)) p = JSM.MidCoord(n, p);
      else {
        p = JSM.CoordAdd(n, p);
        for (n = 0; 2 > n; n++) r = 0 === n ? q.pgon1 : q.pgon2, r = b.GetVertexPosition(d[r]), p = JSM.CoordAdd(p, r);
  ...
  (function (a, b, c, d) {
    ...
    var n = [],
      q, p;
    for (p = 0; p < c.edges.length; p++) q = c.edges[p], q = JSM.MidCoord(a.GetVertexPosition(q.vert1), a.GetVertexPosition(q.vert2)), n.push(q);
    var r, s, v, u;
    for (p = 0; p < c.verts.length; p++)
      if (r = c.verts[p], s = b.GetVertexPosition(p), c.IsContourVertex(r)) {
        v = 0;
        u = new JSM.Coord(0, 0, 0);
        for (a = 0; a < r.edges.length; a++) q = r.edges[a], c.IsContourEdge(c.edges[q]) && (q = n[r.edges[a]], u.Add(q), v++);
        u.Add(s);
        v++;
        ...
        u = new JSM.Coord(0,
          0, 0);
        for (a = 0; a < r.pgons.length; a++) q = r.pgons[a], q = b.GetVertexPosition(d[q]), v.Add(q);
        v.MultiplyScalar(1 / r.pgons.length);
        for (a = 0; a < r.edges.length; a++) q = r.edges[a], q = n[q], u.Add(q);
  ...
  (function (a, b, c, d, e) {
    ...
    for (s = 0; s < c.pgons.length; s++) {
      u = c.pgons[s];
      m = u.verts.length;
      for (v = 0; v < m; v++) n = u.pedges[v], q = u.pedges[(v + 1) % m], p = d[s], n = e[n.index], r = c.GetPolyEdgeStartVertex(q), q = e[q.index], p = new JSM.BodyPolygon([p, n, r, q]), q = a.GetPolygon(s),
        p.material = q.material, p.curved = q.curved, b.AddPolygon(p)
    }
  })(a, b, c, d, e);
  return b
};
JSM.CatmullClarkSubdivision = function (a, b) {
  var c = a,
    d;
  for (d = 0; d < b; d++) c = JSM.CatmullClarkSubdivisionOneIteration(c);
  return c
};
JSM.BooleanOperation = function (a, b, c) {
  function d(a, b, c, d) {
    ...
    var f = new JSM.BodyPolygon([]),
      g;
    if (d)
      for (d = a.VertexCount() - 1; 0 <= d; d--) g = e(a.GetVertex(d), c), f.AddVertexIndex(g);
    else
      for (d = 0; d < a.VertexCount(); d++) g = e(a.GetVertex(d), c), f.AddVertexIndex(g);
  ...
  function f(a, b, c, d, e, f) {
    function g(a, b) {
      var c, d;
      for (c = 0; c <
        a.length; c++) d = a[c], void 0 === d.userData && (d.userData = b)
    }
    var h, k;
    for (h = 0; h < a.length; h++) k = a[h], JSM.ClipPolygonWithBSPTree(k.polygon, b, c, d, e, f), g(c, k.userData), g(d, k.userData), g(e, k.userData), g(f, k.userData)
  }
  ...
  "Union" == a ? (e(k,
    g, b, !1), e(m, g, b, !1), e(n, g, b, !1), e(q, g, b, !1), e(r, g, b, !1)) : "Difference" == a ? (e(k, g, b, !1), e(m, g, b, !1), e(p, g, b, !0)) : "Intersection" == a && (e(l, g, b, !1), e(n, g, b, !1), e(p, g, b, !1));
  return g
};
JSM.GenerateSurface = function (a, b, c, d, e, f, g, h) {
  ...
  (function (a, b, e, f, k) {
    var r, s, v, u;
    for (r = 0; r <= d; r++)
      for (s = 0; s <= c; s++) v = b + s * f, u = e + r * k, v = g(r, s, v, u, h), a.AddVertex(new JSM.BodyVertex(v))
  })(k, a[0], b[0], (a[1] - a[0]) / c, (b[1] - b[0]) / d);
  (function (a) {
    var b, g, h, k, r, s;
    for (g = 0; g < d; g++)
      for (b = 0; b < c; b++) h = g * (c + 1) + b, k = h + 1, r = h + c + 1, s = r + 1, e ? (k = new JSM.BodyPolygon([h, k, s]), f && k.SetCurveGroup(0), a.AddPolygon(k), k = new JSM.BodyPolygon([h, s, r])) : k = new JSM.BodyPolygon([h, k, s, r]), f && k.SetCurveGroup(0), a.AddPolygon(k)
  })(k);
  return k
};
JSM.SurfaceControlPoints = function (a, b) {
  ...
  for (c = 0; c <= this.n; c++) {
    this.points.push([]);
    for (d = 0; d <= this.m; d++) this.points[c].push(new JSM.Coord(0, 0, 0))
  }
};
...
JSM.SurfaceControlPoints.prototype.InitPlanar = function (a, b) {
  var c = a / this.n,
    ...
    e, f, g;
  for (e = 0; e <= this.n; e++)
    for (f = 0; f <= this.m; f++) g = this.points[e][f], g.x = e * c, g.y = f * d
};
JSM.GenerateBezierSurface = function (a, b, c, d) {
  return JSM.GenerateSurface([0, 1], [0, 1], b, c, !1, d, function (a, b, c, d, k) {
    var l, m, n, q = k.GetNValue(),
      p = k.GetMValue();
    l = new JSM.Coord(0, 0, 0);
    for (a = 0; a <= q; a++) {
      m = new JSM.Coord(0, 0, 0);
      for (b = 0; b <= p; b++) n = JSM.BernsteinPolynomial(a, q, c) * JSM.BernsteinPolynomial(b, p, d), n = k.GetControlPoint(a, b).Clone().MultiplyScalar(n), m = JSM.CoordAdd(m, n);
      l = JSM.CoordAdd(l, m)
    }
    return l
  }, a)
